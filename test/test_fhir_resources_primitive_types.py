...
def test_fhir_primitive_type_implicit_type_casting(
    fieldType, inputValue, expectedValue
):
    ...
    assert instance.field == expectedValue  # type: ignore
...
@pytest.mark.parametrize(
    "fieldType, inputValue, serializedValue", fhir_types_serialization_test_cases
)
