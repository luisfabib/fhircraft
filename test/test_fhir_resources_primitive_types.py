...
fhir_types_test_cases = (
    ...
    ('Instant', '2015-02-07T13:28:17.239', datetime(2015,2,7,13,28,17,239000)),
    ('Date', '2015-02-07', date(2015,2,7)),
    ('Date', '2015-02', date(2015,2,1)),
    ('Date', '2015', date(2015,1,1)),
    ('Date', date(2015,2,7), date(2015,2,7)),
    ('DateTime', '2015-02-07T13:28:17.239', datetime(2015,2,7,13,28,17,239000)),
    ('DateTime', '2015-02-07', datetime(2015,2,7)),
    ('DateTime', '2015-02', datetime(2015,2,1)),
    ('DateTime', '2015', datetime(2015,1,1)),
...
fhir_types_serialization_test_cases = (
    ...
    ('Canonical', 'example.com/resources/1234', 'example.com/resources/1234'),
    ('Base64Binary', 'aGVsbG8gd29yaw==', 'aGVsbG8gd29yaw=='),
    ('Instant', '2015-02-07T13:28:17.239', '2015-02-07T13:28:17.239000'),
    ('Date', '2015-02-07', '2015-02-07'),
    ('Date', '2015-02', '2015-02-01'),
    ('Date', '2015', '2015-01-01'),
    ('DateTime', '2015-02-07T13:28:17.239', '2015-02-07T13:28:17.239000'),
    ('DateTime', '2015-02-07', '2015-02-07T00:00:00'),
    ('DateTime', '2015-02', '2015-02-01T00:00:00'),
    ('DateTime',  '2015', '2015-01-01T00:00:00'),
    ('Time', '12:54', '12:54:00'),
