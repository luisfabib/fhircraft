...
class TestValidationIntegration:
    ...
    def test_validation_respects_disabled_warnings(self):
        ...
        from fhircraft.fhir.resources.validators import _validate_FHIR_element_constraint
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            assert len([warning for warning in w 
                       if 'Test constraint' in str(warning.message)]) == 0
    ...
    def test_validation_with_context_manager(self):
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            with with_config(disable_validation_warnings=True):
                ...
                assert len([warning for warning in w 
                           if 'Test in context' in str(warning.message)]) == 0
