...
def test_extension_selects_correct_extension_by_url():
    resource = namedtuple('Resource', 'extension')(extension=[
        ExtensionType(url='http://domain.org/extension1', valueInteger=1),
        ExtensionType(url='http://domain.org/extension2', valueInteger=2),
        ExtensionType(url='http://domain.org/extension3', valueInteger=3),
    ])
