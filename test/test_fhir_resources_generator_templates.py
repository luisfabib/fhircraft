...
def test_render_class__single_base(jinja_env):
    model_obj = GeneratorModel(
        name="TestModel",
        bases=["BaseModel"],
    )

    rendered = jinja_env.render_class(model_obj)
...
def test_render_class__multiple_bases(jinja_env):
    model_obj = GeneratorModel(
        name="TestModel",
        bases=["BaseModel", "AnotherBaseModel"],
    )

    rendered = jinja_env.render_class(model_obj)

    expected = dedent("""
        class TestModel(BaseModel, AnotherBaseModel):
...
def test_render_class__simple_docstring(jinja_env):
    model_obj = GeneratorModel(
        name="TestModel",
        bases=["BaseModel"],
        docstring="This is a simple test model.",
    )
...
def test_render_class__multiline_docstring(jinja_env):
    model_obj = GeneratorModel(
        name="TestModel",
        bases=["BaseModel"],
        docstring="This is a\nmultiline test model.",
    )
...
def test_render_class__metadata(jinja_env):
    model_obj = GeneratorModel(
        name="TestModel",
        bases=["FHIRBaseModel"],
...
def test_render_class__model_with_field(jinja_env):
    model_obj = GeneratorModel(
        name="TestModel",
        bases=["FHIRBaseModel"],
        fields=[
...
def test_render_class__model_with_field_validator(jinja_env):
    model_obj = GeneratorModel(
        name="TestModel",
        bases=["FHIRBaseModel"],
        field_validators=[
...
def test_render_class__model_with_model_validator(jinja_env):
    model_obj = GeneratorModel(
        name="TestModel",
        bases=["FHIRBaseModel"],
        model_validators=[
