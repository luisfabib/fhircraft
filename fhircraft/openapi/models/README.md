...
# Credits
The files in this directory were modified from the original implementation by Mike Oakley and Kuimono for the `openapi-pydantice` pacakge (OpenAPI Schema Pydantic, see [MIT License](https://github.com/mike-oakley/openapi-pydantic/blob/main/LICENSE)).