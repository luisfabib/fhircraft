...
with open('fhircraft\\fhir\\resources\\definitions\\profiles-types.json', 'r', encoding='utf-8') as file: 
...
with open('fhircraft\\fhir\\resources\\definitions\\profiles-resources.json', 'r', encoding='utf-8') as file: 
    datatypes_bundle = json.load(file)
...
with open(f'fhircraft\\fhir\\resources\\datatypes\\R4B\\complex_types.py', '+w', encoding='utf-8') as file:
