...
class TerminologyCapabilitiesExpansion(BackboneElement):
    """
    Information about the [ValueSet/$expand](https://www.hl7.org/fhir/R4/valueset-operation-expand.html) operation.
    """
...
class TerminologyCapabilitiesValidateCode(BackboneElement):
    """
    Information about the [ValueSet/$validate-code](https://hl7.org/fhir/R4/valueset-operation-validate-code.html) operation.
    """
...
class TerminologyCapabilitiesTranslation(BackboneElement):
    """
    Information about the [ConceptMap/$translate](https://hl7.org/fhir/R4/conceptmap-operation-translate.html) operation.
    """
...
class TerminologyCapabilities(DomainResource):
    ...
    expansion: Optional[TerminologyCapabilitiesExpansion] = Field(
        description="Information about the [ValueSet/$expand](https://www.hl7.org/fhir/R4/valueset-operation-expand.html) operation",
        default=None,
    )
    ...
    translation: Optional[TerminologyCapabilitiesTranslation] = Field(
        description="Information about the [ConceptMap/$translate](https://hl7.org/fhir/R4/conceptmap-operation-translate.html) operation",
        default=None,
    )
    closure: Optional[TerminologyCapabilitiesClosure] = Field(
        description="Information about the [ConceptMap/$closure](https://hl7.org/fhir/R4/conceptmap-operation-closure.html) operation",
        default=None,
    )
