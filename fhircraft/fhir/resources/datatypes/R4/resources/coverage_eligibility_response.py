# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:32:23.542237.
...
from fhircraft.fhir.resources.datatypes.R4.complex_types import Extension,Meta,Narrative,Resource,Identifier,Reference,Period,BackboneElement,CodeableConcept,Money
...
class CoverageEligibilityResponse(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='4.0.1', profile=['http://hl7.org/fhir/StructureDefinition/CoverageEligibilityResponse']),
    )
