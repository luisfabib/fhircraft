# Code autogenerated by Fhircraft 0.2.0 on 2025-09-18 11:13:15.171736.
...
from fhircraft.fhir.resources.datatypes.R4.complex_types import Extension,Meta,Narrative,Resource,Identifier,Reference,CodeableConcept,MarketingStatus,BackboneElement,Quantity,ProdCharacteristic,ProductShelfLife
...
class MedicinalProductPackagedPackageItem(BackboneElement):
    ...
    @field_validator(*('manufacturer', 'shelfLifeStorage', 'otherCharacteristics', 'physicalCharacteristics', 'manufacturedItem', 'device', 'alternateMaterial', 'material', 'quantity', 'type', 'identifier', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
...
class MedicinalProductPackaged(FHIRBaseModel):
    ...
    packageItem: List[MedicinalProductPackagedPackageItem] = Field(
