# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:33:17.569099.
...
from fhircraft.fhir.resources.datatypes.R4.complex_types import Extension,Meta,Narrative,Resource,Identifier,Coding,CodeableConcept,ContactPoint,Address,BackboneElement,Reference
...
class LocationHoursOfOperation(BackboneElement):
    ...
    openingTime_ext: Optional[Extension] = Field(
    ...
    closingTime_ext: Optional[Extension] = Field(
...
class Location(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='4.0.1', profile=['http://hl7.org/fhir/StructureDefinition/Location']),
    )
