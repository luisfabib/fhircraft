# Code autogenerated by Fhircraft 0.2.0 on 2025-09-18 11:13:50.016736.
...
from fhircraft.fhir.resources.datatypes.R4.complex_types import Extension,Meta,Narrative,Resource,Identifier,CodeableConcept,Reference,BackboneElement,Quantity,Attachment,Range,Ratio
...
class SubstanceSpecificationProperty(BackboneElement):
    ...
    parameters_ext: Optional[Extension] = Field(
...
class SubstanceSpecification(FHIRBaseModel):
    ...
    @field_validator(*('sourceMaterial', 'protein', 'polymer', 'nucleicAcid', 'relationship', 'name', 'code', 'structure', 'referenceInformation', 'property_', 'moiety', 'comment', 'source', 'description', 'domain', 'status', 'type', 'identifier', 'modifierExtension', 'extension', 'text', 'language', 'implicitRules', 'meta'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
