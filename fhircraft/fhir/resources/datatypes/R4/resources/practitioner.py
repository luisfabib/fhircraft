# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:34:01.444194.
...
from fhircraft.fhir.resources.datatypes.R4.complex_types import Extension,Meta,Narrative,Resource,Identifier,HumanName,ContactPoint,Address,Attachment,BackboneElement,CodeableConcept,Period,Reference
...
class Practitioner(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='4.0.1', profile=['http://hl7.org/fhir/StructureDefinition/Practitioner']),
    )
