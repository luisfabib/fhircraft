# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 09:35:36.218953.
...
from fhircraft.fhir.resources.datatypes.R4.complex_types import Extension,Meta,Narrative,Resource,CodeableConcept,BackboneElement,SubstanceAmount,Attachment
...
class SubstancePolymerRepeatRepeatUnit(BackboneElement):
    ...
    repeatUnit_ext: Optional[Extension] = Field(
...
class SubstancePolymerRepeat(BackboneElement):
    ...
    numberOfUnits_ext: Optional[Extension] = Field(
...
class SubstancePolymer(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default=Meta(versionId='4.0.1', profile=['http://hl7.org/fhir/StructureDefinition/SubstancePolymer']),
    )
