# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:32:46.918035.
...
from fhircraft.fhir.resources.datatypes.primitives import String,Uri,Code,DateTime,Markdown,Date,Canonical,Boolean
 
from fhircraft.fhir.resources.datatypes.R4.complex_types import Extension,Meta,Narrative,Resource,Identifier,ContactDetail,Annotation,UsageContext,CodeableConcept,Period,RelatedArtifact,BackboneElement,Reference,Expression,DataRequirement,TriggerDefinition,Duration,Timing
...
class EvidenceVariableCharacteristic(BackboneElement):
    ...
    groupMeasure_ext: Optional[Extension] = Field(
    ...
    @field_validator(*('groupMeasure', 'timeFromStart', 'exclude', 'usageContext', 'description', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    ...
    def definition_type_choice_validator(self):
        return fhir_validators.validate_type_choice_element( 
            self,
            field_types=[Reference, Canonical, CodeableConcept, Expression, DataRequirement, TriggerDefinition],
...
class EvidenceVariable(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='4.0.1', profile=['http://hl7.org/fhir/StructureDefinition/EvidenceVariable']),
    )
    ...
    @field_validator(*('characteristic', 'type', 'relatedArtifact', 'endorser', 'reviewer', 'editor', 'author', 'topic', 'effectivePeriod', 'lastReviewDate', 'approvalDate', 'copyright', 'jurisdiction', 'useContext', 'note', 'description', 'contact', 'publisher', 'date', 'status', 'subtitle', 'shortTitle', 'title', 'name', 'version', 'identifier', 'url', 'modifierExtension', 'extension', 'text', 'language', 'implicitRules', 'meta'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
