# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 09:35:37.566193.
...
from fhircraft.fhir.resources.datatypes.R4.complex_types import Extension,Meta,Narrative,Resource,CodeableConcept,Identifier,BackboneElement
...
class SubstanceSourceMaterialFractionDescription(BackboneElement):
    ...
    fraction_ext: Optional[Extension] = Field(
...
class SubstanceSourceMaterialOrganismAuthor(BackboneElement):
    ...
    authorDescription_ext: Optional[Extension] = Field(
...
class SubstanceSourceMaterialOrganismHybrid(BackboneElement):
    ...
    maternalOrganismId_ext: Optional[Extension] = Field(
    ...
    maternalOrganismName_ext: Optional[Extension] = Field(
    ...
    paternalOrganismId_ext: Optional[Extension] = Field(
    ...
    paternalOrganismName_ext: Optional[Extension] = Field(
...
class SubstanceSourceMaterialOrganism(BackboneElement):
    ...
    intraspecificDescription_ext: Optional[Extension] = Field(
...
class SubstanceSourceMaterial(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default=Meta(versionId='4.0.1', profile=['http://hl7.org/fhir/StructureDefinition/SubstanceSourceMaterial']),
    )
    ...
    organismName_ext: Optional[Extension] = Field(
    ...
    parentSubstanceName_ext: Optional[Extension] = Field(
    ...
    geographicalLocation_ext: Optional[Extension] = Field(
