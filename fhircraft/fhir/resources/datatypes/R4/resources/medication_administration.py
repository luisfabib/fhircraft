# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:33:24.568458.
...
from fhircraft.fhir.resources.datatypes.R4.complex_types import Extension,Meta,Narrative,Resource,Identifier,Reference,CodeableConcept,Period,BackboneElement,Annotation,Quantity,Ratio
...
class MedicationAdministration(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='4.0.1', profile=['http://hl7.org/fhir/StructureDefinition/MedicationAdministration']),
    )
