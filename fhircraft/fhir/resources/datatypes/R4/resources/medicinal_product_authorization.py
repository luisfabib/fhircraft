# Code autogenerated by Fhircraft 0.2.0 on 2025-09-18 11:13:11.344883.
...
from fhircraft.fhir.resources.datatypes.R4.complex_types import Extension,Meta,Narrative,Resource,Identifier,Reference,CodeableConcept,Period,BackboneElement
...
class MedicinalProductAuthorizationProcedure(BackboneElement):
    ...
    @field_validator(*('type', 'identifier', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
...
class MedicinalProductAuthorization(FHIRBaseModel):
    ...
    restoreDate_ext: Optional[Extension] = Field(
    ...
    dateOfFirstAuthorization_ext: Optional[Extension] = Field(
    ...
    internationalBirthDate_ext: Optional[Extension] = Field(
