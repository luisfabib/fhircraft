# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:33:12.977119.
...
from fhircraft.fhir.resources.datatypes.R4.complex_types import Extension,Meta,Narrative,Resource,Identifier,CodeableConcept,Period,Reference,BackboneElement,HumanName,ContactPoint,Address,Quantity,Money
...
class InsurancePlanPlanGeneralCost(BackboneElement):
    ...
    groupSize_ext: Optional[Extension] = Field(
...
class InsurancePlan(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='4.0.1', profile=['http://hl7.org/fhir/StructureDefinition/InsurancePlan']),
    )
