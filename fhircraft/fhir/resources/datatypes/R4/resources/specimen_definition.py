# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 09:35:32.562606.
...
from fhircraft.fhir.resources.datatypes.R4.complex_types import Extension,Meta,Narrative,Resource,Identifier,CodeableConcept,BackboneElement,Quantity,Reference,Duration,Range
...
class SpecimenDefinition(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default=Meta(versionId='4.0.1', profile=['http://hl7.org/fhir/StructureDefinition/SpecimenDefinition']),
    )
