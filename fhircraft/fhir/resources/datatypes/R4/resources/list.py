# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:33:16.559812.
...
from fhircraft.fhir.resources.datatypes.R4.complex_types import Extension,Meta,Narrative,Resource,Identifier,CodeableConcept,Reference,Annotation,BackboneElement
...
class ListEntry(BackboneElement):
    ...
    deleted_ext: Optional[Extension] = Field(
...
class List(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='4.0.1', profile=['http://hl7.org/fhir/StructureDefinition/List']),
    )
