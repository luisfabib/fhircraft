# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:34:52.560131.
...
from fhircraft.fhir.resources.datatypes.R4.complex_types import Extension,Meta,Narrative,Resource,Reference,CodeableConcept,Timing,BackboneElement,Signature
...
class VerificationResult(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='4.0.1', profile=['http://hl7.org/fhir/StructureDefinition/VerificationResult']),
    )
