# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:32:45.697020.
...
from fhircraft.fhir.resources.datatypes.primitives import String,Uri,Code,DateTime,Markdown,Date
 
from fhircraft.fhir.resources.datatypes.R4.complex_types import Extension,Meta,Narrative,Resource,Identifier,ContactDetail,Annotation,UsageContext,CodeableConcept,Period,RelatedArtifact,Reference
...
class Evidence(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='4.0.1', profile=['http://hl7.org/fhir/StructureDefinition/Evidence']),
    )
    ...
    @field_validator(*('outcome', 'exposureVariant', 'exposureBackground', 'relatedArtifact', 'endorser', 'reviewer', 'editor', 'author', 'topic', 'effectivePeriod', 'lastReviewDate', 'approvalDate', 'copyright', 'jurisdiction', 'useContext', 'note', 'description', 'contact', 'publisher', 'date', 'status', 'subtitle', 'shortTitle', 'title', 'name', 'version', 'identifier', 'url', 'modifierExtension', 'extension', 'text', 'language', 'implicitRules', 'meta'), mode="after", check_fields=None)
    @classmethod
