# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 09:35:29.096785.
...
from fhircraft.fhir.resources.datatypes.R4.complex_types import Extension,Meta,Narrative,Resource,Identifier,ContactDetail,Annotation,UsageContext,CodeableConcept,Period,RelatedArtifact,Reference,BackboneElement
...
class RiskEvidenceSynthesisRiskEstimatePrecisionEstimate(BackboneElement):
    ...
    from_ext: Optional[Extension] = Field(
    ...
    to_ext: Optional[Extension] = Field(
...
class RiskEvidenceSynthesisRiskEstimate(BackboneElement):
    ...
    denominatorCount_ext: Optional[Extension] = Field(
    ...
    numeratorCount_ext: Optional[Extension] = Field(
...
class RiskEvidenceSynthesis(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default=Meta(versionId='4.0.1', profile=['http://hl7.org/fhir/StructureDefinition/RiskEvidenceSynthesis']),
    )
