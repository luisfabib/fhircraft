# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 09:35:06.456586.
...
from fhircraft.fhir.resources.datatypes.R4.complex_types import Extension,Meta,Narrative,Resource,Identifier,CodeableConcept,Coding,MarketingStatus,Reference,BackboneElement
...
class MedicinalProductManufacturingBusinessOperation(BackboneElement):
    ...
    effectiveDate_ext: Optional[Extension] = Field(
...
class MedicinalProduct(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default=Meta(versionId='4.0.1', profile=['http://hl7.org/fhir/StructureDefinition/MedicinalProduct']),
    )
    ...
    specialMeasures_ext: Optional[Extension] = Field(
