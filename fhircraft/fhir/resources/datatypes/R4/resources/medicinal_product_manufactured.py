# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:33:35.974021.
...
from fhircraft.fhir.resources.datatypes.R4.complex_types import Extension,Meta,Narrative,Resource,CodeableConcept,Quantity,Reference,ProdCharacteristic
...
class MedicinalProductManufactured(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='4.0.1', profile=['http://hl7.org/fhir/StructureDefinition/MedicinalProductManufactured']),
    )
    ...
    @field_validator(*('otherCharacteristics', 'physicalCharacteristics', 'ingredient', 'manufacturer', 'quantity', 'unitOfPresentation', 'manufacturedDoseForm', 'modifierExtension', 'extension', 'text', 'language', 'implicitRules', 'meta'), mode="after", check_fields=None)
    @classmethod
