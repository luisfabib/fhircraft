# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:33:34.097274.
...
from fhircraft.fhir.resources.datatypes.R4.complex_types import Extension,Meta,Narrative,Resource,Reference,CodeableConcept,Quantity,BackboneElement,Population
...
class MedicinalProductIndication(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='4.0.1', profile=['http://hl7.org/fhir/StructureDefinition/MedicinalProductIndication']),
    )
    ...
    @field_validator(*('population', 'undesirableEffect', 'otherTherapy', 'duration', 'intendedEffect', 'comorbidity', 'diseaseStatus', 'diseaseSymptomProcedure', 'subject', 'modifierExtension', 'extension', 'text', 'language', 'implicitRules', 'meta'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
