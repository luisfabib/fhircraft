# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:34:39.882568.
...
from fhircraft.fhir.resources.datatypes.R4.complex_types import Extension,Meta,Narrative,Resource,Identifier,Reference,CodeableConcept,BackboneElement,Quantity,Period,Timing
...
class SupplyDelivery(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='4.0.1', profile=['http://hl7.org/fhir/StructureDefinition/SupplyDelivery']),
    )
