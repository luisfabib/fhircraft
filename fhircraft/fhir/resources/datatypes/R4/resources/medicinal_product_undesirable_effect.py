# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:33:38.075824.
...
from fhircraft.fhir.resources.datatypes.R4.complex_types import Extension,Meta,Narrative,Resource,Reference,CodeableConcept,Population
...
class MedicinalProductUndesirableEffect(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='4.0.1', profile=['http://hl7.org/fhir/StructureDefinition/MedicinalProductUndesirableEffect']),
    )
    ...
    @field_validator(*('population', 'frequencyOfOccurrence', 'classification', 'symptomConditionEffect', 'subject', 'modifierExtension', 'extension', 'text', 'language', 'implicitRules', 'meta'), mode="after", check_fields=None)
    @classmethod
