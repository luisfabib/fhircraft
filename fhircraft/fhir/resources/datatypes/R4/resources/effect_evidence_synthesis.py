# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 09:34:39.927892.
...
class EffectEvidenceSynthesisResultsByExposure(BackboneElement):
    ...
    exposureState_ext: Optional[Extension] = Field(
...
class EffectEvidenceSynthesis(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default=Meta(versionId='4.0.1', profile=['http://hl7.org/fhir/StructureDefinition/EffectEvidenceSynthesis']),
    )
