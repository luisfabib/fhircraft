# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:34:33.845863.
...
from fhircraft.fhir.resources.datatypes.R4.complex_types import Extension,Meta,Narrative,Resource,CodeableConcept,BackboneElement,Attachment,Identifier
...
class SubstanceNucleicAcidSubunitLinkage(BackboneElement):
    ...
    connectivity_ext: Optional[Extension] = Field(
    ...
    residueSite_ext: Optional[Extension] = Field(
...
class SubstanceNucleicAcidSubunit(BackboneElement):
    ...
    subunit_ext: Optional[Extension] = Field(
...
class SubstanceNucleicAcid(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='4.0.1', profile=['http://hl7.org/fhir/StructureDefinition/SubstanceNucleicAcid']),
    )
    ...
    numberOfSubunits_ext: Optional[Extension] = Field(
    ...
    areaOfHybridisation_ext: Optional[Extension] = Field(
