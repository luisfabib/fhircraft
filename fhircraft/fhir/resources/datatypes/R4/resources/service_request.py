# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 09:35:30.743523.
...
from fhircraft.fhir.resources.datatypes.R4.complex_types import Extension,Meta,Narrative,Resource,Identifier,Reference,CodeableConcept,Quantity,Ratio,Range,Period,Timing,Annotation
...
class ServiceRequest(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default=Meta(versionId='4.0.1', profile=['http://hl7.org/fhir/StructureDefinition/ServiceRequest']),
    )
