# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:29:12.639905.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,BackboneElement,CodeableConcept,Period,Reference
...
class ResearchSubjectProgress(BackboneElement):
    ...
    startDate_ext: Optional[Extension] = Field(
    ...
    endDate_ext: Optional[Extension] = Field(
...
class ResearchSubject(FHIRBaseModel):
    ...
    assignedComparisonGroup_ext: Optional[Extension] = Field(
    ...
    actualComparisonGroup_ext: Optional[Extension] = Field(
...
ResearchSubjectProgress.model_rebuild()
