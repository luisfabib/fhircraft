# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:28:39.144298.
...
from fhircraft.fhir.resources.datatypes.primitives import String,Uri,Code,DateTime,Date,PositiveInt,Markdown
 
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,CodeableConcept,Reference,Period,BackboneElement,MonetaryComponent,Money,Annotation
...
class Invoice(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/Invoice']),
    )
    ...
    cancelledReason_ext: Optional[Extension] = Field(
    ...
    creation_ext: Optional[Extension] = Field(
    ...
    paymentTerms_ext: Optional[Extension] = Field(
    ...
    @field_validator(*('note', 'paymentTerms', 'totalGross', 'totalNet', 'totalPriceComponent', 'lineItem', 'account', 'issuer', 'participant', 'creation', 'date', 'recipient', 'subject', 'type', 'cancelledReason', 'status', 'identifier', 'modifierExtension', 'extension', 'text', 'language', 'implicitRules', 'meta'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
