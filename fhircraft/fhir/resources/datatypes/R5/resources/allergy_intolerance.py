# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 09:27:33.692370.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,CodeableConcept,Reference,Age,Period,Range,BackboneElement,Annotation,CodeableReference
...
class AllergyIntoleranceReaction(BackboneElement):
    ...
    manifestation: List[CodeableReference] = Field(
...
class AllergyIntolerance(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default=Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/AllergyIntolerance']),
    )
...
AllergyIntoleranceParticipant.model_rebuild()
