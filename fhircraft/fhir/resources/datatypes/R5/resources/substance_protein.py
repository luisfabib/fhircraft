# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:29:25.150284.
...
class SubstanceProteinSubunit(BackboneElement):
    ...
    nTerminalModification_ext: Optional[Extension] = Field(
    ...
    cTerminalModification_ext: Optional[Extension] = Field(
...
class SubstanceProtein(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/SubstanceProtein']),
    )
    ...
    disulfideLinkage_ext: Optional[Extension] = Field(
