# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:29:30.734561.
...
from fhircraft.fhir.resources.datatypes.primitives import String,Uri,Code,Canonical,Decimal,DateTime,Markdown
 
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,BackboneElement
...
class TestReportSetupActionOperation(BackboneElement):
    ...
    result_ext: Optional[Extension] = Field(
    ...
    detail_ext: Optional[Extension] = Field(
...
class TestReportSetupActionAssert(BackboneElement):
    ...
    @field_validator(*('requirement', 'detail', 'message', 'result', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
...
class TestReport(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/TestReport']),
    )
    ...
    tester_ext: Optional[Extension] = Field(
