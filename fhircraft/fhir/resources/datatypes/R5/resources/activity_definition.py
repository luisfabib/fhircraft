# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:27:34.988005.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,Coding,CodeableConcept,Reference,ContactDetail,UsageContext,Period,RelatedArtifact,Timing,Age,Range,Duration,CodeableReference,BackboneElement,Quantity,Dosage,Expression
...
class ActivityDefinition(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/ActivityDefinition']),
    )
    ...
    specimenRequirement_ext: Optional[Extension] = Field(
    ...
    observationRequirement_ext: Optional[Extension] = Field(
    ...
    observationResultRequirement_ext: Optional[Extension] = Field(
