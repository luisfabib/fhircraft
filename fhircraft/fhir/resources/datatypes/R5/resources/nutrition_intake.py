# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 09:28:51.799301.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,Reference,CodeableConcept,Period,BackboneElement,CodeableReference,Timing,Quantity,Annotation
...
class NutritionIntakeConsumedItem(BackboneElement):
    ...
    notConsumed_ext: Optional[Extension] = Field(
...
class NutritionIntake(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default=Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/NutritionIntake']),
    )
    ...
    consumedItem: List[NutritionIntakeConsumedItem] = Field(
...
NutritionIntakeConsumedItem.model_rebuild()

NutritionIntakeIngredientLabel.model_rebuild()
