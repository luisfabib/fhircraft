# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:28:27.985978.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,CodeableConcept,Reference,BackboneElement,Period,Age,Range,CodeableReference,Annotation
...
class FamilyMemberHistoryCondition(BackboneElement):
    ...
    contributedToDeath_ext: Optional[Extension] = Field(
...
class FamilyMemberHistory(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/FamilyMemberHistory']),
    )
    ...
    estimatedAge_ext: Optional[Extension] = Field(
    ...
    @field_validator(*('procedure', 'condition', 'note', 'reason', 'estimatedAge', 'sex', 'relationship', 'name', 'participant', 'date', 'patient', 'dataAbsentReason', 'status', 'instantiatesUri', 'instantiatesCanonical', 'identifier', 'modifierExtension', 'extension', 'text', 'language', 'implicitRules', 'meta'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
