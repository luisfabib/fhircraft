# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 09:28:53.185596.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,Reference,CodeableReference,CodeableConcept,BackboneElement,Timing,Quantity,Ratio,Annotation
...
class NutritionOrderEnteralFormula(BackboneElement):
    ...
    baseFormulaProductName_ext: Optional[Extension] = Field(
    ...
    administrationInstruction_ext: Optional[Extension] = Field(
...
class NutritionOrder(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default=Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/NutritionOrder']),
    )
    ...
    dateTime_ext: Optional[Extension] = Field(
    ...
    outsideFoodAllowed_ext: Optional[Extension] = Field(
...
NutritionOrderEnteralFormulaAdditive.model_rebuild()
