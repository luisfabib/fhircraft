# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 09:29:23.159785.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,ContactPoint,Reference,BackboneElement,Coding
...
class Subscription(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default=Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/Subscription']),
    )
    ...
    heartbeatPeriod_ext: Optional[Extension] = Field(
    ...
    timeout_ext: Optional[Extension] = Field(
    ...
    maxCount_ext: Optional[Extension] = Field(
