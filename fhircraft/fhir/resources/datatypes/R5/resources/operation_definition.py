# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 09:28:56.739989.
...
class OperationDefinitionParameter(BackboneElement):
    ...
    allowedType_ext: Optional[Extension] = Field(
...
class OperationDefinition(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default=Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/OperationDefinition']),
    )
