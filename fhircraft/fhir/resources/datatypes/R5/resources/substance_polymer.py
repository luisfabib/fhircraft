# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 09:29:29.344197.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,CodeableConcept,BackboneElement,Quantity,Attachment
...
class SubstancePolymerRepeatRepeatUnitDegreeOfPolymerisation(BackboneElement):
    ...
    average_ext: Optional[Extension] = Field(
    ...
    low_ext: Optional[Extension] = Field(
    ...
    high_ext: Optional[Extension] = Field(
...
class SubstancePolymerRepeatRepeatUnit(BackboneElement):
    ...
    unit_ext: Optional[Extension] = Field(
...
class SubstancePolymerRepeat(BackboneElement):
    ...
    averageMolecularFormula_ext: Optional[Extension] = Field(
...
class SubstancePolymer(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default=Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/SubstancePolymer']),
    )
    ...
    modification_ext: Optional[Extension] = Field(
