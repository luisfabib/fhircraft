# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:29:16.218690.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,CodeableConcept,Reference,BackboneElement,Period,Duration,Quantity,CodeableReference,Annotation
...
class SpecimenCollection(BackboneElement):
    ...
    @field_validator(*('bodySite', 'procedure', 'device', 'method', 'quantity', 'duration', 'collector', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
...
class SpecimenProcessing(BackboneElement):
    ...
    @field_validator(*('additive', 'method', 'description', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
...
class SpecimenContainer(BackboneElement):
    ...
    @field_validator(*('specimenQuantity', 'location', 'device', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
...
class Specimen(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/Specimen']),
    )
    ...
    receivedTime_ext: Optional[Extension] = Field(
    ...
    combined_ext: Optional[Extension] = Field(
    ...
    @field_validator(*('note', 'condition', 'container', 'processing', 'collection', 'feature', 'role', 'combined', 'request', 'parent', 'receivedTime', 'subject', 'type', 'status', 'accessionIdentifier', 'identifier', 'modifierExtension', 'extension', 'text', 'language', 'implicitRules', 'meta'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
