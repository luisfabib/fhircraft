# Code autogenerated by Fhircraft 0.2.0 on 2025-09-18 11:02:49.082540.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,Reference,CodeableConcept,Period,CodeableReference,BackboneElement
...
class RegulatedAuthorizationCase(BackboneElement):
    ...
    @field_validator(*('status', 'type', 'identifier', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
...
class RegulatedAuthorization(FHIRBaseModel):
    ...
    @field_validator(*('case', 'attachedDocument', 'regulator', 'holder', 'basis', 'intendedUse', 'indication', 'validityPeriod', 'statusDate', 'status', 'region', 'description', 'type', 'subject', 'identifier', 'modifierExtension', 'extension', 'text', 'language', 'implicitRules', 'meta'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
