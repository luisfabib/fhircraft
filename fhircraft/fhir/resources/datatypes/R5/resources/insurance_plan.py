# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:28:37.568764.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,CodeableConcept,Period,Reference,ExtendedContactDetail,BackboneElement,Quantity,Money
...
class InsurancePlan(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/InsurancePlan']),
    )
