# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:29:22.485945.
...
class Substance(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/Substance']),
    )
