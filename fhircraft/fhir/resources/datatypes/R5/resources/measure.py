# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 09:28:41.310074.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,Coding,CodeableConcept,Reference,ContactDetail,UsageContext,Period,RelatedArtifact,BackboneElement,Expression
...
class MeasureGroupPopulation(BackboneElement):
    ...
    inputPopulationId_ext: Optional[Extension] = Field(
...
class MeasureGroup(BackboneElement):
    ...
    basis_ext: Optional[Extension] = Field(
...
class Measure(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default=Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/Measure']),
    )
