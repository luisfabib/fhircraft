# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:28:12.551154.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,Reference,CodeableReference,CodeableConcept,BackboneElement,Quantity,Annotation
...
class DeviceDispense(FHIRBaseModel):
    ...
    preparedDate_ext: Optional[Extension] = Field(
