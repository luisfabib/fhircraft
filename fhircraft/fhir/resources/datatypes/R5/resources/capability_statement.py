# Code autogenerated by Fhircraft 0.2.0 on 2025-09-18 11:00:14.281642.
...
class CapabilityStatementRestResource(BackboneElement):
    ...
    conditionalPatch_ext: Optional[Extension] = Field(
...
class CapabilityStatementRest(BackboneElement):
    ...
    @field_validator(*('compartment', 'interaction', 'resource', 'security', 'documentation', 'mode', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
...
class CapabilityStatement(FHIRBaseModel):
    ...
    acceptLanguage_ext: Optional[Extension] = Field(
