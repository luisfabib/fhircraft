# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:29:09.468782.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,Reference,CodeableConcept,HumanName,ContactPoint,Address,Attachment,Period,BackboneElement
...
class RelatedPerson(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/RelatedPerson']),
    )
