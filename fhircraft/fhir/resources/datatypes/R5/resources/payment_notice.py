# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:29:00.810521.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,Reference,Money,CodeableConcept
...
class PaymentNotice(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/PaymentNotice']),
    )
    ...
    @field_validator(*('paymentStatus', 'amount', 'recipient', 'payee', 'paymentDate', 'payment', 'reporter', 'created', 'response', 'request', 'status', 'identifier', 'modifierExtension', 'extension', 'text', 'language', 'implicitRules', 'meta'), mode="after", check_fields=None)
    @classmethod
