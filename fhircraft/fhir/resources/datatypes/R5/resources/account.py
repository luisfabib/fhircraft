# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 09:27:29.972002.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,CodeableConcept,Reference,Period,BackboneElement,CodeableReference,Money
...
class AccountGuarantor(BackboneElement):
    ...
    onHold_ext: Optional[Extension] = Field(
...
class AccountDiagnosis(BackboneElement):
    ...
    dateOfDiagnosis_ext: Optional[Extension] = Field(
    ...
    onAdmission_ext: Optional[Extension] = Field(
...
class AccountProcedure(BackboneElement):
    ...
    dateOfService_ext: Optional[Extension] = Field(
...
class AccountBalance(BackboneElement):
    ...
    estimate_ext: Optional[Extension] = Field(
...
class Account(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default=Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/Account']),
    )
    ...
    calculatedAt_ext: Optional[Extension] = Field(
...
AccountRelatedAccount.model_rebuild()
