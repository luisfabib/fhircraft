# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 09:28:45.609066.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,CodeableConcept,Reference,BackboneElement,Period,Money,CodeableReference,Dosage,Quantity,Range,Annotation,Duration,Ratio,Attachment
...
class MedicationKnowledge(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default=Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/MedicationKnowledge']),
    )
