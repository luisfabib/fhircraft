# Code autogenerated by Fhircraft 0.2.0 on 2025-09-18 11:02:48.620996.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,Reference,BackboneElement,Attachment,Coding,Quantity
...
class QuestionnaireResponseItem(BackboneElement):
    ...
    @field_validator(*('answer', 'text', 'definition', 'linkId', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
...
class QuestionnaireResponse(FHIRBaseModel):
    ...
    questionnaire: Canonical = Field(
        description="Canonical URL of Questionnaire being answered",
    )
    questionnaire_ext: Optional[Extension] = Field(
    ...
    authored_ext: Optional[Extension] = Field(
