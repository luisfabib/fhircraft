# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:29:06.358439.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,Reference,CodeableConcept,Period,Age,Range,Timing,BackboneElement,CodeableReference,Annotation
...
class ProcedurePerformer(BackboneElement):
    ...
    @field_validator(*('period', 'onBehalfOf', 'actor', 'function', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
...
class Procedure(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/Procedure']),
    )
    ...
    @field_validator(*('supportingInfo', 'used', 'focalDevice', 'note', 'followUp', 'complication', 'report', 'outcome', 'bodySite', 'reason', 'location', 'performer', 'recorder', 'recorded', 'encounter', 'focus', 'subject', 'code', 'category', 'statusReason', 'status', 'partOf', 'basedOn', 'instantiatesUri', 'instantiatesCanonical', 'identifier', 'modifierExtension', 'extension', 'text', 'language', 'implicitRules', 'meta'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
