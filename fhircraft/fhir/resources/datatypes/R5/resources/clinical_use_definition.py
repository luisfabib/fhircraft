# Code autogenerated by Fhircraft 0.2.0 on 2025-09-18 11:00:29.940879.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,CodeableConcept,Reference,BackboneElement,CodeableReference,Expression,Range
...
class ClinicalUseDefinitionIndication(BackboneElement):
    ...
    @field_validator(*('applicability', 'undesirableEffect', 'intendedEffect', 'comorbidity', 'diseaseStatus', 'diseaseSymptomProcedure', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
