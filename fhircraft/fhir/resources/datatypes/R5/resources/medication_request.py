# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:28:47.965468.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,Reference,CodeableConcept,CodeableReference,Annotation,Period,Dosage,BackboneElement,Quantity,Duration
...
class MedicationRequestDispenseRequest(BackboneElement):
    ...
    numberOfRepeatsAllowed_ext: Optional[Extension] = Field(
...
class MedicationRequest(FHIRBaseModel):
    ...
    statusChanged_ext: Optional[Extension] = Field(
    ...
    renderedDosageInstruction_ext: Optional[Extension] = Field(
