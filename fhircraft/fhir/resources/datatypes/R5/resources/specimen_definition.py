# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 09:29:20.558096.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,Coding,CodeableConcept,Reference,ContactDetail,UsageContext,Period,BackboneElement,Quantity,Duration,Range
...
class SpecimenDefinitionTypeTestedContainer(BackboneElement):
    ...
    preparation_ext: Optional[Extension] = Field(
...
class SpecimenDefinitionTypeTestedHandling(BackboneElement):
    ...
    instruction_ext: Optional[Extension] = Field(
...
class SpecimenDefinitionTypeTested(BackboneElement):
    ...
    isDerived_ext: Optional[Extension] = Field(
    ...
    preference_ext: Optional[Extension] = Field(
    ...
    requirement_ext: Optional[Extension] = Field(
    ...
    singleUse_ext: Optional[Extension] = Field(
...
class SpecimenDefinition(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default=Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/SpecimenDefinition']),
    )
    ...
    timeAspect_ext: Optional[Extension] = Field(
