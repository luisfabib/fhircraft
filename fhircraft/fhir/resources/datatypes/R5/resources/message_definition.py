# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:28:50.261867.
...
class MessageDefinitionAllowedResponse(BackboneElement):
    ...
    situation_ext: Optional[Extension] = Field(
...
class MessageDefinition(FHIRBaseModel):
    ...
    parent_ext: Optional[Extension] = Field(
    ...
    category_ext: Optional[Extension] = Field(
    ...
    responseRequired_ext: Optional[Extension] = Field(
    ...
    graph_ext: Optional[Extension] = Field(
