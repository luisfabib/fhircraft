# Code autogenerated by Fhircraft 0.2.0 on 2025-09-18 11:02:31.233637.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,CodeableConcept,Reference,Quantity,BackboneElement,MarketingStatus,ProductShelfLife,Attachment,CodeableReference
...
class PackagedProductDefinitionPackaging(BackboneElement):
    ...
    componentPart_ext: Optional[Extension] = Field(
    ...
    @field_validator(*('containedItem', 'property_', 'manufacturer', 'shelfLifeStorage', 'alternateMaterial', 'material', 'quantity', 'componentPart', 'type', 'identifier', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
...
class PackagedProductDefinition(FHIRBaseModel):
    ...
    @field_validator(*('packaging', 'attachedDocument', 'manufacturer', 'copackagedIndicator', 'marketingStatus', 'legalStatusOfSupply', 'description', 'containedItemQuantity', 'statusDate', 'status', 'packageFor', 'type', 'name', 'identifier', 'modifierExtension', 'extension', 'text', 'language', 'implicitRules', 'meta'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
