# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:28:40.847365.
...
from fhircraft.fhir.resources.datatypes.primitives import String,Uri,Code,Markdown,Decimal
 
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,Coding,CodeableConcept,ExtendedContactDetail,Address,BackboneElement,Reference,Availability,VirtualServiceDetail
...
class LocationPosition(BackboneElement):
    ...
    longitude_ext: Optional[Extension] = Field(
    ...
    latitude_ext: Optional[Extension] = Field(
    ...
    altitude_ext: Optional[Extension] = Field(
...
class Location(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/Location']),
    )
    ...
    @field_validator(*('endpoint', 'virtualService', 'hoursOfOperation', 'characteristic', 'partOf', 'managingOrganization', 'position', 'form', 'address', 'contact', 'type', 'mode', 'description', 'alias', 'name', 'operationalStatus', 'status', 'identifier', 'modifierExtension', 'extension', 'text', 'language', 'implicitRules', 'meta'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
