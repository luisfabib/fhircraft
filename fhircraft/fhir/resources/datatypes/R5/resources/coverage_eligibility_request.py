# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:28:08.074132.
...
from fhircraft.fhir.resources.datatypes.primitives import String,Uri,Code,DateTime,Date,PositiveInt,Boolean
 
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,CodeableConcept,Reference,BackboneElement,Period,Quantity,Money
...
class CoverageEligibilityRequestSupportingInfo(BackboneElement):
    ...
    appliesToAll_ext: Optional[Extension] = Field(
...
class CoverageEligibilityRequestItem(BackboneElement):
    ...
    supportingInfoSequence_ext: Optional[Extension] = Field(
...
class CoverageEligibilityRequest(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/CoverageEligibilityRequest']),
    )
    ...
    @field_validator(*('item', 'insurance', 'supportingInfo', 'facility', 'insurer', 'provider', 'enterer', 'created', 'event', 'patient', 'purpose', 'priority', 'status', 'identifier', 'modifierExtension', 'extension', 'text', 'language', 'implicitRules', 'meta'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
