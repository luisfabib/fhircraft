# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 09:28:42.432240.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,Reference,Period,CodeableConcept,BackboneElement,Quantity,Range,Duration
...
class MeasureReport(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default=Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/MeasureReport']),
    )
    ...
    dataUpdateType_ext: Optional[Extension] = Field(
