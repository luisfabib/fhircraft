# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 09:29:14.027571.
...
class RequirementsStatement(BackboneElement):
    ...
    conformance_ext: Optional[Extension] = Field(
    ...
    satisfiedBy_ext: Optional[Extension] = Field(
...
class Requirements(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default=Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/Requirements']),
    )
    ...
    actor_ext: Optional[Extension] = Field(
