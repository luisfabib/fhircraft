# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:28:17.716296.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,CodeableConcept,Reference,ContactPoint,Period,BackboneElement
...
class EndpointPayload(BackboneElement):
    ...
    mimeType_ext: Optional[Extension] = Field(
        description="Placeholder element for mimeType extensions",
        default=None,
        alias="_mimeType",
    )
    @field_validator(*('mimeType', 'type', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
...
class Endpoint(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/Endpoint']),
    )
    ...
    connectionType: List[CodeableConcept] = Field(
    ...
    @field_validator(*('header', 'address', 'payload', 'period', 'contact', 'managingOrganization', 'environmentType', 'description', 'name', 'connectionType', 'status', 'identifier', 'modifierExtension', 'extension', 'text', 'language', 'implicitRules', 'meta'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
