# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 09:28:50.475254.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,Reference,Attachment,BackboneElement,CodeableConcept,Range
...
class MolecularSequenceRelativeEdit(BackboneElement):
    ...
    replacementSequence_ext: Optional[Extension] = Field(
    ...
    replacedSequence_ext: Optional[Extension] = Field(
...
class MolecularSequenceRelative(BackboneElement):
    ...
    ordinalPosition_ext: Optional[Extension] = Field(
...
class MolecularSequence(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default=Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/MolecularSequence']),
    )
    ...
    literal_ext: Optional[Extension] = Field(
...
MolecularSequenceRelativeStartingSequence.model_rebuild()
