# Code autogenerated by Fhircraft 0.2.0 on 2025-09-18 11:00:18.722145.
...
class ChargeItemDefinitionPropertyGroup(BackboneElement):
    ...
    @field_validator(*('priceComponent', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
