# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:27:47.900844.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,Coding,ContactDetail,UsageContext,CodeableConcept,Reference,BackboneElement,Expression,Period,RelatedArtifact,MonetaryComponent
...
class ChargeItemDefinition(FHIRBaseModel):
    ...
    derivedFromUri_ext: Optional[Extension] = Field(
    ...
    partOf_ext: Optional[Extension] = Field(
    ...
    replaces_ext: Optional[Extension] = Field(
