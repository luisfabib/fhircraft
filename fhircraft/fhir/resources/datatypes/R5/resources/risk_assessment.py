# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 09:29:16.632923.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,Reference,CodeableConcept,Period,CodeableReference,BackboneElement,Range,Annotation
...
class RiskAssessment(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default=Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/RiskAssessment']),
    )
