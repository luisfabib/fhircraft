# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 09:27:34.885474.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,CodeableConcept,CodeableReference,Reference,VirtualServiceDetail,Period,Annotation,BackboneElement,Coding
...
class AppointmentRecurrenceTemplateWeeklyTemplate(BackboneElement):
    ...
    monday_ext: Optional[Extension] = Field(
    ...
    tuesday_ext: Optional[Extension] = Field(
    ...
    wednesday_ext: Optional[Extension] = Field(
    ...
    thursday_ext: Optional[Extension] = Field(
    ...
    friday_ext: Optional[Extension] = Field(
    ...
    saturday_ext: Optional[Extension] = Field(
    ...
    sunday_ext: Optional[Extension] = Field(
    ...
    weekInterval_ext: Optional[Extension] = Field(
...
class AppointmentRecurrenceTemplateMonthlyTemplate(BackboneElement):
    ...
    dayOfMonth_ext: Optional[Extension] = Field(
    ...
    monthInterval: PositiveInt = Field(
        description="Recurs every nth month",
        default=...,
    )
    monthInterval_ext: Optional[Extension] = Field(
...
class AppointmentRecurrenceTemplateYearlyTemplate(BackboneElement):
    ...
    """
    yearInterval: PositiveInt = Field(
        description="Recurs every nth year",
        default=...,
    )
    yearInterval_ext: Optional[Extension] = Field(
...
class AppointmentRecurrenceTemplate(BackboneElement):
    ...
    lastOccurrenceDate_ext: Optional[Extension] = Field(
    ...
    occurrenceCount_ext: Optional[Extension] = Field(
    ...
    occurrenceDate_ext: Optional[Extension] = Field(
    ...
    excludingDate_ext: Optional[Extension] = Field(
    ...
    excludingRecurrenceId_ext: Optional[Extension] = Field(
...
class Appointment(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default=Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/Appointment']),
    )
    ...
    minutesDuration_ext: Optional[Extension] = Field(
    ...
    cancellationDate_ext: Optional[Extension] = Field(
    ...
    recurrenceId_ext: Optional[Extension] = Field(
    ...
    occurrenceChanged_ext: Optional[Extension] = Field(
