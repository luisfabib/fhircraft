# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 09:28:32.013974.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,Reference,CodeableConcept,CodeableReference,Quantity,BackboneElement,Annotation
...
class ImmunizationProtocolApplied(BackboneElement):
    ...
    doseNumber: String = Field(
        description="Dose number within series",
        default=...,
    )
    doseNumber_ext: Optional[Extension] = Field(
    ...
    seriesDoses_ext: Optional[Extension] = Field(
...
class Immunization(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default=Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/Immunization']),
    )
