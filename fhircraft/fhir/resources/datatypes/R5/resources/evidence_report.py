# Code autogenerated by Fhircraft 0.2.0 on 2025-09-18 11:01:14.708692.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,UsageContext,Identifier,Reference,CodeableConcept,Annotation,RelatedArtifact,BackboneElement,Quantity,Range,Period,ContactDetail
...
class EvidenceReportSection(BackboneElement):
    ...
    @field_validator(*('emptyReason', 'entryQuantity', 'entryReference', 'entryClassifier', 'orderedBy', 'mode', 'text', 'author', 'focusReference', 'focus', 'title', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
...
EvidenceReportSubjectCharacteristic.model_rebuild()

EvidenceReportSubject.model_rebuild()

EvidenceReportRelatesToTarget.model_rebuild()

EvidenceReportRelatesTo.model_rebuild()

EvidenceReportSection.model_rebuild()

EvidenceReport.model_rebuild()
