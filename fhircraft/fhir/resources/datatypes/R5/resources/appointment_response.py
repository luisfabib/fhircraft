# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:27:39.160378.
...
from fhircraft.fhir.resources.datatypes.primitives import String,Uri,Code,Boolean,Instant,Markdown,Date,PositiveInt
 
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,Reference,CodeableConcept
...
class AppointmentResponse(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/AppointmentResponse']),
    )
    ...
    proposedNewTime_ext: Optional[Extension] = Field(
    ...
    participantStatus: Code = Field(
        description="accepted | declined | tentative | needs-action | entered-in-error",
    )
    participantStatus_ext: Optional[Extension] = Field(
    ...
    recurring_ext: Optional[Extension] = Field(
    ...
    @field_validator(*('recurrenceId', 'occurrenceDate', 'recurring', 'comment', 'participantStatus', 'actor', 'participantType', 'end', 'start', 'proposedNewTime', 'appointment', 'identifier', 'modifierExtension', 'extension', 'text', 'language', 'implicitRules', 'meta'), mode="after", check_fields=None)
    @classmethod
