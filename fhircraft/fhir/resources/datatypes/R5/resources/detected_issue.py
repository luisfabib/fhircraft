# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:28:09.589420.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,CodeableConcept,Reference,Period,BackboneElement,Annotation
...
class DetectedIssueMitigation(BackboneElement):
    ...
    @field_validator(*('note', 'author', 'date', 'action', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
...
class DetectedIssue(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/DetectedIssue']),
    )
    ...
    severity_ext: Optional[Extension] = Field(
    ...
    @field_validator(*('mitigation', 'reference', 'detail', 'evidence', 'implicated', 'author', 'encounter', 'subject', 'severity', 'code', 'category', 'status', 'identifier', 'modifierExtension', 'extension', 'text', 'language', 'implicitRules', 'meta'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
