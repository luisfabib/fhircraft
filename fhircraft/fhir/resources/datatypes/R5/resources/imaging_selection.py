# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 09:28:30.265417.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,Reference,BackboneElement,CodeableConcept,CodeableReference,Coding
...
class ImagingSelectionInstance(BackboneElement):
    ...
    subset_ext: Optional[Extension] = Field(
...
class ImagingSelection(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default=Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/ImagingSelection']),
    )
    ...
    studyUid_ext: Optional[Extension] = Field(
    ...
    seriesUid_ext: Optional[Extension] = Field(
    ...
    seriesNumber_ext: Optional[Extension] = Field(
    ...
    frameOfReferenceUid_ext: Optional[Extension] = Field(
...
ImagingSelectionInstanceImageRegion3D.model_rebuild()
