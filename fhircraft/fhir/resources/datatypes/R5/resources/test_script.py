# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 09:29:37.382857.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,Coding,ContactDetail,UsageContext,CodeableConcept,BackboneElement,Reference
...
class TestScriptOrigin(BackboneElement):
    ...
    index_ext: Optional[Extension] = Field(
...
class TestScriptMetadataCapability(BackboneElement):
    ...
    validated: Boolean = Field(
        description="Are the capabilities validated?",
        default=...,
    )
    validated_ext: Optional[Extension] = Field(
    ...
    origin_ext: Optional[Extension] = Field(
    ...
    destination_ext: Optional[Extension] = Field(
    ...
    link_ext: Optional[Extension] = Field(
    ...
    capabilities_ext: Optional[Extension] = Field(
...
class TestScriptScope(BackboneElement):
    ...
    """
    artifact: Canonical = Field(
        description="The specific conformance artifact being tested",
        default=...,
    )
    artifact_ext: Optional[Extension] = Field(
...
class TestScriptVariable(BackboneElement):
    ...
    defaultValue_ext: Optional[Extension] = Field(
    ...
    headerField_ext: Optional[Extension] = Field(
    ...
    hint_ext: Optional[Extension] = Field(
    ...
    sourceId_ext: Optional[Extension] = Field(
...
class TestScriptSetupActionOperationRequestHeader(BackboneElement):
    ...
    field_ext: Optional[Extension] = Field(
...
class TestScriptSetupActionOperation(BackboneElement):
    ...
    resource_ext: Optional[Extension] = Field(
    ...
    accept_ext: Optional[Extension] = Field(
    ...
    contentType_ext: Optional[Extension] = Field(
    ...
    encodeRequestUrl: Boolean = Field(
        description="Whether or not to send the request url in encoded format",
        default=...,
    )
    encodeRequestUrl_ext: Optional[Extension] = Field(
    ...
    method_ext: Optional[Extension] = Field(
    ...
    params_ext: Optional[Extension] = Field(
    ...
    requestId_ext: Optional[Extension] = Field(
    ...
    responseId_ext: Optional[Extension] = Field(
...
class TestScriptSetupActionAssert(BackboneElement):
    ...
    direction_ext: Optional[Extension] = Field(
    ...
    compareToSourceId_ext: Optional[Extension] = Field(
    ...
    compareToSourceExpression_ext: Optional[Extension] = Field(
    ...
    compareToSourcePath_ext: Optional[Extension] = Field(
    ...
    defaultManualCompletion_ext: Optional[Extension] = Field(
    ...
    minimumId_ext: Optional[Extension] = Field(
    ...
    navigationLinks_ext: Optional[Extension] = Field(
    ...
    requestMethod_ext: Optional[Extension] = Field(
    ...
    requestURL_ext: Optional[Extension] = Field(
    ...
    response_ext: Optional[Extension] = Field(
    ...
    responseCode_ext: Optional[Extension] = Field(
    ...
    stopTestOnFail: Boolean = Field(
        description="If this assert fails, will the current test execution stop?",
        default=...,
    )
    stopTestOnFail_ext: Optional[Extension] = Field(
    ...
    validateProfileId_ext: Optional[Extension] = Field(
    ...
    warningOnly: Boolean = Field(
        description="Will this assert produce a warning only on error?",
        default=...,
    )
    warningOnly_ext: Optional[Extension] = Field(
...
class TestScript(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default=Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/TestScript']),
    )
