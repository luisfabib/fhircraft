# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 09:28:11.785120.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,CodeableConcept,CodeableReference,Reference,BackboneElement,Period,VirtualServiceDetail,Duration
...
class Encounter(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default=Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/Encounter']),
    )
    ...
    plannedStartDate_ext: Optional[Extension] = Field(
    ...
    plannedEndDate_ext: Optional[Extension] = Field(
