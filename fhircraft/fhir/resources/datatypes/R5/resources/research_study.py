# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 09:29:15.674759.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,BackboneElement,CodeableConcept,Reference,RelatedArtifact,CodeableReference,Period,Annotation
...
class ResearchStudyRecruitment(BackboneElement):
    ...
    targetNumber_ext: Optional[Extension] = Field(
    ...
    actualNumber_ext: Optional[Extension] = Field(
...
class ResearchStudy(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default=Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/ResearchStudy']),
    )
    ...
    descriptionSummary_ext: Optional[Extension] = Field(
...
ResearchStudyOutcomeMeasure.model_rebuild()
