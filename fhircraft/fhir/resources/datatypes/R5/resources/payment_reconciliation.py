# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:29:01.503435.
...
from fhircraft.fhir.resources.datatypes.primitives import String,Uri,Code,DateTime,Date,PositiveInt
 
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,CodeableConcept,Period,Reference,Money,BackboneElement
...
class PaymentReconciliationAllocation(BackboneElement):
    ...
    @field_validator(*('amount', 'payee', 'responsible', 'date', 'response', 'submitter', 'type', 'account', 'encounter', 'target', 'predecessor', 'identifier', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
...
class PaymentReconciliationProcessNote(BackboneElement):
    ...
    @field_validator(*('text', 'type', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
...
class PaymentReconciliation(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/PaymentReconciliation']),
    )
    ...
    cardBrand_ext: Optional[Extension] = Field(
    ...
    accountNumber_ext: Optional[Extension] = Field(
    ...
    expirationDate_ext: Optional[Extension] = Field(
    ...
    processor_ext: Optional[Extension] = Field(
    ...
    referenceNumber_ext: Optional[Extension] = Field(
    ...
    authorization_ext: Optional[Extension] = Field(
    ...
    @field_validator(*('processNote', 'formCode', 'allocation', 'paymentIdentifier', 'amount', 'returnedAmount', 'tenderedAmount', 'authorization', 'referenceNumber', 'processor', 'expirationDate', 'accountNumber', 'cardBrand', 'method', 'location', 'date', 'disposition', 'outcome', 'requestor', 'request', 'paymentIssuer', 'issuerType', 'enterer', 'created', 'period', 'kind', 'status', 'type', 'identifier', 'modifierExtension', 'extension', 'text', 'language', 'implicitRules', 'meta'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
