# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:28:31.660241.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,Reference,CodeableConcept,Attachment,ExtendedContactDetail,BackboneElement,Availability
...
class HealthcareService(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/HealthcareService']),
    )
    ...
    extraDetails_ext: Optional[Extension] = Field(
    ...
    appointmentRequired_ext: Optional[Extension] = Field(
    ...
    @field_validator(*('endpoint', 'availability', 'appointmentRequired', 'referralMethod', 'communication', 'characteristic', 'program', 'eligibility', 'serviceProvisionCode', 'coverageArea', 'contact', 'photo', 'extraDetails', 'comment', 'name', 'location', 'specialty', 'type', 'category', 'offeredIn', 'providedBy', 'active', 'identifier', 'modifierExtension', 'extension', 'text', 'language', 'implicitRules', 'meta'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
