# Code autogenerated by Fhircraft 0.2.0 on 2025-09-18 11:01:36.186985.
...
class ImplementationGuideDependsOn(BackboneElement):
    ...
    packageId_ext: Optional[Extension] = Field(
...
class ImplementationGuideDefinitionResource(BackboneElement):
    ...
    isExample_ext: Optional[Extension] = Field(
    ...
    groupingId_ext: Optional[Extension] = Field(
...
class ImplementationGuideDefinitionPage(BackboneElement):
    ...
    generation_ext: Optional[Extension] = Field(
        description="Placeholder element for generation extensions",
        default=None,
        alias="_generation",
    )
    @field_validator(*('generation', 'title', 'name', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
...
class ImplementationGuideManifestResource(BackboneElement):
    ...
    relativePath_ext: Optional[Extension] = Field(
...
class ImplementationGuideManifestPage(BackboneElement):
    ...
    anchor_ext: Optional[Extension] = Field(
...
class ImplementationGuideManifest(BackboneElement):
    ...
    rendering_ext: Optional[Extension] = Field(
    ...
    image_ext: Optional[Extension] = Field(
    ...
    other_ext: Optional[Extension] = Field(
...
class ImplementationGuide(FHIRBaseModel):
    ...
    license_ext: Optional[Extension] = Field(
        description="Placeholder element for license extensions",
        default=None,
        alias="_license",
    )
    fhirVersion: List[Code] = Field(
