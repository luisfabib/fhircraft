# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 09:29:34.547064.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,Coding,ContactDetail,UsageContext,CodeableConcept,Reference,BackboneElement,CodeableReference
...
class TestPlanTestCaseTestRun(BackboneElement):
    ...
    narrative_ext: Optional[Extension] = Field(
...
class TestPlan(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default=Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/TestPlan']),
    )
    ...
    testTools_ext: Optional[Extension] = Field(
    ...
    exitCriteria_ext: Optional[Extension] = Field(
