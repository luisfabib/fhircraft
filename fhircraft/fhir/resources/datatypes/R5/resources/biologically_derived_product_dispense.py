# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 09:27:37.960264.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,Reference,CodeableConcept,BackboneElement,Quantity,Annotation
...
class BiologicallyDerivedProductDispense(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default=Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/BiologicallyDerivedProductDispense']),
    )
