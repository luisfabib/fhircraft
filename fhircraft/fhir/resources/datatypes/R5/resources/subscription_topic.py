# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:29:22.181004.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,Coding,ContactDetail,UsageContext,CodeableConcept,Period,BackboneElement
...
class SubscriptionTopicResourceTriggerQueryCriteria(BackboneElement):
    ...
    previous_ext: Optional[Extension] = Field(
    ...
    resultForCreate_ext: Optional[Extension] = Field(
    ...
    current_ext: Optional[Extension] = Field(
    ...
    resultForDelete_ext: Optional[Extension] = Field(
    ...
    requireBoth_ext: Optional[Extension] = Field(
...
class SubscriptionTopicResourceTrigger(BackboneElement):
    ...
    supportedInteraction_ext: Optional[Extension] = Field(
    ...
    fhirPathCriteria_ext: Optional[Extension] = Field(
...
class SubscriptionTopicCanFilterBy(BackboneElement):
    ...
    filterParameter_ext: Optional[Extension] = Field(
    ...
    filterDefinition_ext: Optional[Extension] = Field(
    ...
    comparator_ext: Optional[Extension] = Field(
    ...
    modifier_ext: Optional[Extension] = Field(
...
class SubscriptionTopicNotificationShape(BackboneElement):
    ...
    include_ext: Optional[Extension] = Field(
    ...
    revInclude_ext: Optional[Extension] = Field(
...
SubscriptionTopicResourceTriggerQueryCriteria.model_rebuild()

SubscriptionTopicResourceTrigger.model_rebuild()

SubscriptionTopicEventTrigger.model_rebuild()

SubscriptionTopicCanFilterBy.model_rebuild()

SubscriptionTopicNotificationShape.model_rebuild()
