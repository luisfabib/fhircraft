# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 09:27:45.742404.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,Coding,ContactDetail,UsageContext,CodeableConcept,Period,BackboneElement,Annotation,RelatedArtifact,Reference,Attachment
...
class CitationCitedArtifactRelatesTo(BackboneElement):
    ...
    citation_ext: Optional[Extension] = Field(
...
class CitationCitedArtifactPublicationForm(BackboneElement):
    ...
    publicationDateText_ext: Optional[Extension] = Field(
    ...
    publicationDateSeason_ext: Optional[Extension] = Field(
...
class CitationCitedArtifactContributorshipEntry(BackboneElement):
    ...
    forenameInitials_ext: Optional[Extension] = Field(
    ...
    rankingOrder_ext: Optional[Extension] = Field(
...
class Citation(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default=Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/Citation']),
    )
