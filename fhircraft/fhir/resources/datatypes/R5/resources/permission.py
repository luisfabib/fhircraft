# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:29:02.115946.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Reference,Period,BackboneElement,CodeableConcept,Coding,Expression
...
class PermissionJustification(BackboneElement):
    ...
    @field_validator(*('evidence', 'basis', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
...
class PermissionRuleDataResource(BackboneElement):
    ...
    meaning_ext: Optional[Extension] = Field(
...
class PermissionRuleData(BackboneElement):
    ...
    @field_validator(*('expression', 'period', 'security', 'resource', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
...
class PermissionRuleActivity(BackboneElement):
    ...
    @field_validator(*('purpose', 'action', 'actor', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
...
class PermissionRule(BackboneElement):
    ...
    @field_validator(*('limit', 'activity', 'data', 'type', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
...
class Permission(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/Permission']),
    )
    ...
    combining_ext: Optional[Extension] = Field(
    ...
    @field_validator(*('rule', 'combining', 'justification', 'validity', 'date', 'asserter', 'status', 'modifierExtension', 'extension', 'text', 'language', 'implicitRules', 'meta'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
