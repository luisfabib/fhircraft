# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 09:28:44.303289.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,Reference,CodeableReference,CodeableConcept,BackboneElement,Quantity,Annotation,Dosage
...
class MedicationDispense(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default=Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/MedicationDispense']),
    )
