# Code autogenerated by Fhircraft 0.2.0 on 2025-09-18 11:00:08.255286.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,CodeableConcept,BackboneElement,CodeableReference,Quantity,Reference,Attachment
...
class BodyStructure(FHIRBaseModel):
    ...
    includedStructure: List[BodyStructureIncludedStructure] = Field(
    ...
    @field_validator(*('patient', 'image', 'description', 'includedStructure', 'morphology', 'active', 'identifier', 'modifierExtension', 'extension', 'text', 'language', 'implicitRules', 'meta'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
