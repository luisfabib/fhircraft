# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 09:27:32.968276.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,CodeableConcept,Reference,Period,Timing,BackboneElement,Annotation
...
class AdverseEvent(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default=Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/AdverseEvent']),
    )
    ...
    actuality_ext: Optional[Extension] = Field(
    ...
    detected_ext: Optional[Extension] = Field(
    ...
    expectedInResearchStudy_ext: Optional[Extension] = Field(
...
AdverseEventContributingFactor.model_rebuild()

AdverseEventPreventiveAction.model_rebuild()

AdverseEventMitigatingAction.model_rebuild()

AdverseEventSupportingInfo.model_rebuild()
