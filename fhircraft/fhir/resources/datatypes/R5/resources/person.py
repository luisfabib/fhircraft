# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:29:02.560241.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,HumanName,ContactPoint,Address,CodeableConcept,Attachment,BackboneElement,Reference
...
class PersonLink(BackboneElement):
    ...
    assurance_ext: Optional[Extension] = Field(
...
class Person(FHIRBaseModel):
    ...
    active_ext: Optional[Extension] = Field(
    ...
    birthDate_ext: Optional[Extension] = Field(
