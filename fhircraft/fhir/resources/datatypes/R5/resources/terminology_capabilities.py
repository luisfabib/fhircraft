# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:29:29.134681.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,Coding,ContactDetail,UsageContext,CodeableConcept,BackboneElement
...
class TerminologyCapabilitiesCodeSystemVersion(BackboneElement):
    ...
    isDefault_ext: Optional[Extension] = Field(
    ...
    compositional_ext: Optional[Extension] = Field(
...
class TerminologyCapabilitiesCodeSystem(BackboneElement):
    ...
    content_ext: Optional[Extension] = Field(
    ...
    subsumption_ext: Optional[Extension] = Field(
...
class TerminologyCapabilitiesExpansion(BackboneElement):
    ...
    hierarchical_ext: Optional[Extension] = Field(
    ...
    paging_ext: Optional[Extension] = Field(
    ...
    incomplete_ext: Optional[Extension] = Field(
    ...
    textFilter_ext: Optional[Extension] = Field(
...
class TerminologyCapabilitiesValidateCode(BackboneElement):
    ...
    """
    translations: Boolean = Field(
        description="Whether translations are validated",
    )
    translations_ext: Optional[Extension] = Field(
...
class TerminologyCapabilitiesTranslation(BackboneElement):
    ...
    """
    needsMap: Boolean = Field(
        description="Whether the client must identify the map",
    )
    needsMap_ext: Optional[Extension] = Field(
...
class TerminologyCapabilitiesClosure(BackboneElement):
    ...
    translation_ext: Optional[Extension] = Field(
...
class TerminologyCapabilities(FHIRBaseModel):
    ...
    codeSearch_ext: Optional[Extension] = Field(
