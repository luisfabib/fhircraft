# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:28:27.231503.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,CodeableConcept,Reference,Period,BackboneElement,Quantity,Attachment,Coding,Address,Money,CodeableReference
...
class ExplanationOfBenefitCareTeam(BackboneElement):
    ...
    sequence_ext: Optional[Extension] = Field(
    ...
    responsible_ext: Optional[Extension] = Field(
    ...
    @field_validator(*('specialty', 'role', 'responsible', 'provider', 'sequence', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
...
class ExplanationOfBenefitDiagnosis(BackboneElement):
    ...
    @field_validator(*('onAdmission', 'type', 'sequence', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
...
class ExplanationOfBenefitInsurance(BackboneElement):
    ...
    focal_ext: Optional[Extension] = Field(
    ...
    preAuthRef_ext: Optional[Extension] = Field(
...
class ExplanationOfBenefitItemBodySite(BackboneElement):
    ...
    """
    site: List[CodeableReference] = Field(
    ...
    @field_validator(*('subSite', 'site', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
...
class ExplanationOfBenefitItemReviewOutcome(BackboneElement):
    ...
    @field_validator(*('preAuthPeriod', 'preAuthRef', 'reason', 'decision', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
...
class ExplanationOfBenefitItemAdjudication(BackboneElement):
    ...
    @field_validator(*('quantity', 'amount', 'reason', 'category', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
...
class ExplanationOfBenefitItemDetailSubDetail(BackboneElement):
    ...
    factor_ext: Optional[Extension] = Field(
    ...
    noteNumber_ext: Optional[Extension] = Field(
    ...
    @field_validator(*('adjudication', 'reviewOutcome', 'noteNumber', 'udi', 'net', 'tax', 'factor', 'unitPrice', 'quantity', 'patientPaid', 'programCode', 'modifier', 'productOrServiceEnd', 'productOrService', 'category', 'revenue', 'traceNumber', 'sequence', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
...
class ExplanationOfBenefitItemDetail(BackboneElement):
    ...
    @field_validator(*('subDetail', 'adjudication', 'reviewOutcome', 'noteNumber', 'udi', 'net', 'tax', 'factor', 'unitPrice', 'quantity', 'patientPaid', 'programCode', 'modifier', 'productOrServiceEnd', 'productOrService', 'category', 'revenue', 'traceNumber', 'sequence', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
...
class ExplanationOfBenefitItem(BackboneElement):
    ...
    careTeamSequence_ext: Optional[Extension] = Field(
    ...
    diagnosisSequence_ext: Optional[Extension] = Field(
    ...
    procedureSequence_ext: Optional[Extension] = Field(
    ...
    informationSequence_ext: Optional[Extension] = Field(
    ...
    @field_validator(*('detail', 'adjudication', 'reviewOutcome', 'noteNumber', 'encounter', 'bodySite', 'udi', 'net', 'tax', 'factor', 'unitPrice', 'quantity', 'patientPaid', 'programCode', 'modifier', 'request', 'productOrServiceEnd', 'productOrService', 'category', 'revenue', 'traceNumber', 'informationSequence', 'procedureSequence', 'diagnosisSequence', 'careTeamSequence', 'sequence', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
...
class ExplanationOfBenefitAddItemDetailSubDetail(BackboneElement):
    ...
    @field_validator(*('adjudication', 'reviewOutcome', 'noteNumber', 'net', 'tax', 'factor', 'unitPrice', 'quantity', 'patientPaid', 'modifier', 'productOrServiceEnd', 'productOrService', 'revenue', 'traceNumber', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
...
class ExplanationOfBenefitAddItemDetail(BackboneElement):
    ...
    @field_validator(*('subDetail', 'adjudication', 'reviewOutcome', 'noteNumber', 'net', 'tax', 'factor', 'unitPrice', 'quantity', 'patientPaid', 'modifier', 'productOrServiceEnd', 'productOrService', 'revenue', 'traceNumber', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
...
class ExplanationOfBenefitAddItem(BackboneElement):
    ...
    itemSequence_ext: Optional[Extension] = Field(
    ...
    detailSequence_ext: Optional[Extension] = Field(
    ...
    subDetailSequence_ext: Optional[Extension] = Field(
    ...
    @field_validator(*('detail', 'adjudication', 'reviewOutcome', 'noteNumber', 'bodySite', 'net', 'tax', 'factor', 'unitPrice', 'quantity', 'patientPaid', 'programCode', 'modifier', 'request', 'productOrServiceEnd', 'productOrService', 'revenue', 'provider', 'traceNumber', 'subDetailSequence', 'detailSequence', 'itemSequence', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
...
class ExplanationOfBenefitProcessNote(BackboneElement):
    ...
    number_ext: Optional[Extension] = Field(
...
class ExplanationOfBenefitBenefitBalance(BackboneElement):
    ...
    excluded_ext: Optional[Extension] = Field(
...
class ExplanationOfBenefit(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/ExplanationOfBenefit']),
    )
    ...
    use_ext: Optional[Extension] = Field(
    ...
    created_ext: Optional[Extension] = Field(
    ...
    outcome_ext: Optional[Extension] = Field(
    ...
    disposition_ext: Optional[Extension] = Field(
    ...
    precedence_ext: Optional[Extension] = Field(
    ...
    @field_validator(*('benefitBalance', 'benefitPeriod', 'processNote', 'form', 'formCode', 'payment', 'total', 'adjudication', 'addItem', 'item', 'patientPaid', 'accident', 'insurance', 'precedence', 'procedure', 'diagnosis', 'supportingInfo', 'careTeam', 'diagnosisRelatedGroup', 'preAuthRefPeriod', 'preAuthRef', 'disposition', 'decision', 'outcome', 'claimResponse', 'claim', 'facility', 'encounter', 'referral', 'payee', 'event', 'originalPrescription', 'prescription', 'related', 'fundsReserve', 'fundsReserveRequested', 'priority', 'provider', 'insurer', 'enterer', 'created', 'billablePeriod', 'patient', 'use', 'subType', 'type', 'status', 'traceNumber', 'identifier', 'modifierExtension', 'extension', 'text', 'language', 'implicitRules', 'meta'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
