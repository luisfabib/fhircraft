# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 09:27:58.453220.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,Coding,ContactDetail,UsageContext,CodeableConcept,BackboneElement,Quantity,Reference
...
class ConditionDefinition(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default=Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/ConditionDefinition']),
    )
    ...
    hasSeverity_ext: Optional[Extension] = Field(
    ...
    hasBodySite_ext: Optional[Extension] = Field(
    ...
    hasStage_ext: Optional[Extension] = Field(
...
ConditionDefinitionObservation.model_rebuild()
