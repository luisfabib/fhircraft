# Code autogenerated by Fhircraft 0.2.0 on 2025-09-18 11:01:16.992519.
...
class ExampleScenarioActor(BackboneElement):
    ...
    key_ext: Optional[Extension] = Field(
...
class ExampleScenarioInstanceContainedInstance(BackboneElement):
    ...
    """
    instanceReference: String = Field(
        description="Key of contained instance",
    )
    instanceReference_ext: Optional[Extension] = Field(
    ...
    versionReference_ext: Optional[Extension] = Field(
...
class ExampleScenarioInstance(BackboneElement):
    ...
    structureVersion_ext: Optional[Extension] = Field(
...
class ExampleScenarioProcessStepOperation(BackboneElement):
    ...
    initiator_ext: Optional[Extension] = Field(
    ...
    receiver_ext: Optional[Extension] = Field(
    ...
    initiatorActive_ext: Optional[Extension] = Field(
    ...
    receiverActive_ext: Optional[Extension] = Field(
        description="Placeholder element for receiverActive extensions",
        default=None,
        alias="_receiverActive",
    )
    @field_validator(*('receiverActive', 'initiatorActive', 'description', 'receiver', 'initiator', 'title', 'type', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
...
class ExampleScenarioProcessStepAlternative(BackboneElement):
    ...
    @field_validator(*('description', 'title', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
...
class ExampleScenarioProcessStep(BackboneElement):
    ...
    workflow_ext: Optional[Extension] = Field(
    ...
    pause_ext: Optional[Extension] = Field(
        description="Placeholder element for pause extensions",
        default=None,
        alias="_pause",
    )
    @field_validator(*('pause', 'alternative', 'operation', 'workflow', 'number', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
...
class ExampleScenarioProcess(BackboneElement):
    ...
    preConditions_ext: Optional[Extension] = Field(
    ...
    postConditions_ext: Optional[Extension] = Field(
