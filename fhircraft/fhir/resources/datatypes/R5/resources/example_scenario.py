# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 09:28:19.005334.
...
class ExampleScenarioProcess(FHIRBaseModel):
    """
    ...
    @field_validator(*('step', 'postConditions', 'preConditions', 'description', 'title', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
...
class ExampleScenario(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default=Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/ExampleScenario']),
    )
