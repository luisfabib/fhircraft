# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:28:13.617755.
...
from fhircraft.fhir.resources.datatypes.primitives import String,Uri,Code,Canonical,Boolean,Integer,DateTime
 
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,Reference,CodeableReference,BackboneElement,CodeableConcept,Quantity,Range,Period,Timing,Annotation
...
class DeviceRequest(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/DeviceRequest']),
    )
    ...
    asNeeded_ext: Optional[Extension] = Field(
    ...
    @field_validator(*('relevantHistory', 'note', 'supportingInfo', 'insurance', 'asNeededFor', 'asNeeded', 'reason', 'performer', 'requester', 'authoredOn', 'encounter', 'subject', 'parameter', 'quantity', 'code', 'doNotPerform', 'priority', 'intent', 'status', 'groupIdentifier', 'replaces', 'basedOn', 'instantiatesUri', 'instantiatesCanonical', 'identifier', 'modifierExtension', 'extension', 'text', 'language', 'implicitRules', 'meta'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
