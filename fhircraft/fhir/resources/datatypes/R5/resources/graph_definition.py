# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 09:28:28.078266.
...
class GraphDefinitionNode(BackboneElement):
    ...
    nodeId_ext: Optional[Extension] = Field(
...
class GraphDefinition(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default=Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/GraphDefinition']),
    )
