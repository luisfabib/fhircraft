# Code autogenerated by Fhircraft 0.2.0 on 2025-09-18 11:00:31.241789.
...
class CodeSystemConcept(BackboneElement):
    ...
    @field_validator(*('property_', 'designation', 'definition', 'display', 'code', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
...
class CodeSystem(FHIRBaseModel):
    ...
    caseSensitive_ext: Optional[Extension] = Field(
    ...
    hierarchyMeaning_ext: Optional[Extension] = Field(
    ...
    versionNeeded_ext: Optional[Extension] = Field(
    ...
    supplements_ext: Optional[Extension] = Field(
