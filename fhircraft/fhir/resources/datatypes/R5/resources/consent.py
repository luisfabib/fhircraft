# Code autogenerated by Fhircraft 0.2.0 on 2025-09-18 11:00:40.597037.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,CodeableConcept,Reference,Period,Attachment,BackboneElement,Coding,Expression
...
class Consent(FHIRBaseModel):
    ...
    decision_ext: Optional[Extension] = Field(
