# Code autogenerated by Fhircraft 0.2.0 on 2025-09-18 11:02:25.403713.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,Coding,ContactDetail,UsageContext,CodeableConcept,Period,Reference,BackboneElement,Range
...
class ObservationDefinitionQualifiedValue(BackboneElement):
    ...
    gender_ext: Optional[Extension] = Field(
    ...
    rangeCategory_ext: Optional[Extension] = Field(
    ...
    validCodedValueSet_ext: Optional[Extension] = Field(
    ...
    normalCodedValueSet_ext: Optional[Extension] = Field(
    ...
    abnormalCodedValueSet_ext: Optional[Extension] = Field(
    ...
    criticalCodedValueSet_ext: Optional[Extension] = Field(
...
class ObservationDefinitionComponent(BackboneElement):
    ...
    permittedDataType_ext: Optional[Extension] = Field(
    ...
    @field_validator(*('permittedUnit', 'permittedDataType', 'code', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
...
class ObservationDefinition(FHIRBaseModel):
    ...
    derivedFromCanonical_ext: Optional[Extension] = Field(
    ...
    multipleResultsAllowed_ext: Optional[Extension] = Field(
    ...
    preferredReportName_ext: Optional[Extension] = Field(
