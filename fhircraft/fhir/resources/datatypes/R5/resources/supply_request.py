# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:29:26.989625.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,Reference,CodeableConcept,CodeableReference,Quantity,BackboneElement,Range,Period,Timing
...
class SupplyRequest(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/SupplyRequest']),
    )
    ...
    @field_validator(*('deliverTo', 'deliverFrom', 'reason', 'supplier', 'requester', 'authoredOn', 'parameter', 'quantity', 'item', 'deliverFor', 'priority', 'category', 'basedOn', 'status', 'identifier', 'modifierExtension', 'extension', 'text', 'language', 'implicitRules', 'meta'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
