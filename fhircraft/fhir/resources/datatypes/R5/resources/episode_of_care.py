# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:28:18.799169.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,BackboneElement,Period,CodeableConcept,CodeableReference,Reference
...
class EpisodeOfCare(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/EpisodeOfCare']),
    )
    ...
    @field_validator(*('account', 'careTeam', 'careManager', 'referralRequest', 'period', 'managingOrganization', 'patient', 'diagnosis', 'reason', 'type', 'statusHistory', 'status', 'identifier', 'modifierExtension', 'extension', 'text', 'language', 'implicitRules', 'meta'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
