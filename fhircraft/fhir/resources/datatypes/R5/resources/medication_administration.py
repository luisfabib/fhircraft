# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 09:28:43.562501.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,Reference,CodeableConcept,CodeableReference,Period,Timing,BackboneElement,Annotation,Quantity,Ratio
...
class MedicationAdministration(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default=Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/MedicationAdministration']),
    )
