# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:28:07.331645.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,BackboneElement,Reference,CodeableConcept,Period,Quantity,Money
...
class CoveragePaymentBy(BackboneElement):
    ...
    responsibility_ext: Optional[Extension] = Field(
        description="Placeholder element for responsibility extensions",
        default=None,
        alias="_responsibility",
    )
    @field_validator(*('responsibility', 'party', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
...
class CoverageCostToBeneficiary(BackboneElement):
    ...
    @field_validator(*('exception', 'term', 'unit', 'network', 'category', 'type', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
...
class Coverage(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/Coverage']),
    )
    ...
    dependent_ext: Optional[Extension] = Field(
    ...
    order_ext: Optional[Extension] = Field(
    ...
    network_ext: Optional[Extension] = Field(
    ...
    subrogation_ext: Optional[Extension] = Field(
    ...
    @field_validator(*('insurancePlan', 'contract', 'subrogation', 'costToBeneficiary', 'network', 'order', 'class_', 'insurer', 'period', 'relationship', 'dependent', 'beneficiary', 'subscriberId', 'subscriber', 'policyHolder', 'type', 'paymentBy', 'kind', 'status', 'identifier', 'modifierExtension', 'extension', 'text', 'language', 'implicitRules', 'meta'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
