# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:29:20.385540.
...
from fhircraft.fhir.resources.datatypes.primitives import String,Uri,Code,Integer64,Instant,Canonical
 
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,BackboneElement,Reference,CodeableConcept
...
class SubscriptionStatusNotificationEvent(BackboneElement):
    ...
    """
    eventNumber: Integer64 = Field(
        description="Sequencing index of this event",
    )
    eventNumber_ext: Optional[Extension] = Field(
...
class SubscriptionStatus(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/SubscriptionStatus']),
    )
    ...
    eventsSinceSubscriptionStart_ext: Optional[Extension] = Field(
    ...
    topic_ext: Optional[Extension] = Field(
