# Code autogenerated by Fhircraft 0.2.0 on 2025-09-18 11:00:01.388409.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,Reference,BackboneElement,CodeableConcept,Quantity,RelatedArtifact
...
class ArtifactAssessmentContent(BackboneElement):
    ...
    informationType_ext: Optional[Extension] = Field(
    ...
    summary_ext: Optional[Extension] = Field(
    ...
    @field_validator(*('freeToShare', 'relatedArtifact', 'path', 'author', 'quantity', 'classifier', 'type', 'summary', 'informationType', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
...
class ArtifactAssessment(FHIRBaseModel):
    ...
    artifactCanonical: Canonical = Field(
        description="The artifact assessed, commented upon or rated",
    )
    artifactUri: Uri = Field(
        description="The artifact assessed, commented upon or rated",
    )
    ...
    workflowStatus_ext: Optional[Extension] = Field(
