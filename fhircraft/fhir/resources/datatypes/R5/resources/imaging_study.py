# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:28:33.094489.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,CodeableConcept,Reference,CodeableReference,Annotation,BackboneElement,Coding
...
class ImagingStudySeriesInstance(BackboneElement):
    ...
    uid_ext: Optional[Extension] = Field(
...
class ImagingStudySeries(BackboneElement):
    ...
    numberOfInstances_ext: Optional[Extension] = Field(
    ...
    started_ext: Optional[Extension] = Field(
...
class ImagingStudy(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/ImagingStudy']),
    )
    ...
    numberOfSeries_ext: Optional[Extension] = Field(
    ...
    @field_validator(*('series', 'description', 'note', 'reason', 'location', 'procedure', 'numberOfInstances', 'numberOfSeries', 'endpoint', 'referrer', 'partOf', 'basedOn', 'started', 'encounter', 'subject', 'modality', 'status', 'identifier', 'modifierExtension', 'extension', 'text', 'language', 'implicitRules', 'meta'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
