# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 09:28:17.674860.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,Coding,ContactDetail,Annotation,UsageContext,Period,RelatedArtifact,BackboneElement,Reference,CodeableConcept,Expression,Quantity,Range
...
class EvidenceVariableCharacteristicDefinitionByCombination(BackboneElement):
    ...
    threshold_ext: Optional[Extension] = Field(
        description="Placeholder element for threshold extensions",
        default=None,
        alias="_threshold",
    )
    characteristic: List[Any] = Field(
...
class EvidenceVariableCharacteristic(FHIRBaseModel):
    """
    ...
    definitionCanonical_ext: Optional[Extension] = Field(
    ...
    definitionId_ext: Optional[Extension] = Field(
    ...
    @field_validator(*('timeFromEvent', 'definitionByCombination', 'definitionByTypeAndValue', 'definitionId', 'definitionExpression', 'definitionCodeableConcept', 'definitionCanonical', 'definitionReference', 'exclude', 'note', 'description', 'linkId', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
...
class EvidenceVariable(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default=Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/EvidenceVariable']),
    )
...
EvidenceVariableCharacteristicDefinitionByTypeAndValue.model_rebuild()

EvidenceVariableCharacteristicDefinitionByTypeAndValue.model_rebuild()

EvidenceVariableCharacteristicDefinitionByCombination.model_rebuild()

EvidenceVariableCharacteristicTimeFromEvent.model_rebuild()
