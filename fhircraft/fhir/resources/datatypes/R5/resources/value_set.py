# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:29:35.337920.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,Coding,ContactDetail,UsageContext,CodeableConcept,Period,RelatedArtifact,BackboneElement
...
class ValueSetComposeIncludeConcept(BackboneElement):
    ...
    display_ext: Optional[Extension] = Field(
...
class ValueSetComposeIncludeFilter(BackboneElement):
    ...
    """
    property_: Code = Field(
        description="A property/filter defined by the code system",
    )
    property_ext: Optional[Extension] = Field(
    ...
    op_ext: Optional[Extension] = Field(
...
class ValueSetComposeInclude(BackboneElement):
    ...
    system_ext: Optional[Extension] = Field(
    ...
    valueSet_ext: Optional[Extension] = Field(
...
class ValueSetCompose(BackboneElement):
    ...
    lockedDate_ext: Optional[Extension] = Field(
    ...
    inactive_ext: Optional[Extension] = Field(
...
class ValueSetExpansionProperty(BackboneElement):
    ...
    uri_ext: Optional[Extension] = Field(
...
class ValueSetExpansionContains(BackboneElement):
    ...
    abstract_ext: Optional[Extension] = Field(
...
class ValueSetExpansion(BackboneElement):
    ...
    identifier_ext: Optional[Extension] = Field(
    ...
    next_ext: Optional[Extension] = Field(
    ...
    timestamp_ext: Optional[Extension] = Field(
    ...
    total_ext: Optional[Extension] = Field(
    ...
    offset_ext: Optional[Extension] = Field(
...
class ValueSetScope(BackboneElement):
    ...
    inclusionCriteria_ext: Optional[Extension] = Field(
    ...
    exclusionCriteria_ext: Optional[Extension] = Field(
...
class ValueSet(FHIRBaseModel):
    ...
    immutable_ext: Optional[Extension] = Field(
