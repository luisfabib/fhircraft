# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:28:34.312441.
...
class ImmunizationEvaluation(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/ImmunizationEvaluation']),
    )
    ...
    @field_validator(*('seriesDoses', 'doseNumber', 'series', 'description', 'doseStatusReason', 'doseStatus', 'immunizationEvent', 'targetDisease', 'authority', 'date', 'patient', 'status', 'identifier', 'modifierExtension', 'extension', 'text', 'language', 'implicitRules', 'meta'), mode="after", check_fields=None)
    @classmethod
