# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:28:29.611799.
...
from fhircraft.fhir.resources.datatypes.primitives import String,Uri,Code,Boolean,Date,Integer
 
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,CodeableConcept,Reference,BackboneElement,Quantity,Range,Ratio,Duration,Annotation,CodeableReference
...
class Goal(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/Goal']),
    )
    ...
    continuous_ext: Optional[Extension] = Field(
    ...
    statusReason_ext: Optional[Extension] = Field(
    ...
    @field_validator(*('outcome', 'note', 'addresses', 'source', 'statusReason', 'statusDate', 'target', 'subject', 'description', 'priority', 'continuous', 'category', 'achievementStatus', 'lifecycleStatus', 'identifier', 'modifierExtension', 'extension', 'text', 'language', 'implicitRules', 'meta'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
