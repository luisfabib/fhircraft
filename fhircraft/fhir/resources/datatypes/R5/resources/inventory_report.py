# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:28:38.551991.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,CodeableConcept,Reference,Period,BackboneElement,Quantity,CodeableReference,Annotation
...
class InventoryReportInventoryListingItem(BackboneElement):
    ...
    @field_validator(*('item', 'quantity', 'category', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
...
class InventoryReportInventoryListing(BackboneElement):
    ...
    countingDateTime_ext: Optional[Extension] = Field(
    ...
    @field_validator(*('item', 'countingDateTime', 'itemStatus', 'location', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
...
class InventoryReport(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/InventoryReport']),
    )
    ...
    countType: Code = Field(
        description="snapshot | difference",
    )
    countType_ext: Optional[Extension] = Field(
    ...
    reportedDateTime: DateTime = Field(
        description="When the report has been submitted",
    )
    reportedDateTime_ext: Optional[Extension] = Field(
    ...
    @field_validator(*('note', 'inventoryListing', 'reportingPeriod', 'reporter', 'reportedDateTime', 'operationTypeReason', 'operationType', 'countType', 'status', 'identifier', 'modifierExtension', 'extension', 'text', 'language', 'implicitRules', 'meta'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
