# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:29:13.974898.
...
class SearchParameter(FHIRBaseModel):
    ...
    processingMode_ext: Optional[Extension] = Field(
    ...
    constraint_ext: Optional[Extension] = Field(
    ...
    multipleOr_ext: Optional[Extension] = Field(
    ...
    multipleAnd_ext: Optional[Extension] = Field(
    ...
    chain_ext: Optional[Extension] = Field(
