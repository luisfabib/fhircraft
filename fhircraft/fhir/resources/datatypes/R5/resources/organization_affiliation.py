# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:28:58.884824.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,Period,Reference,CodeableConcept,ExtendedContactDetail
...
class OrganizationAffiliation(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/OrganizationAffiliation']),
    )
    ...
    @field_validator(*('endpoint', 'contact', 'healthcareService', 'location', 'specialty', 'code', 'network', 'participatingOrganization', 'organization', 'period', 'active', 'identifier', 'modifierExtension', 'extension', 'text', 'language', 'implicitRules', 'meta'), mode="after", check_fields=None)
    @classmethod
