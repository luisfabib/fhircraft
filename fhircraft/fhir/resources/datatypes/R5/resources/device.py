# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 09:28:05.368823.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,CodeableReference,BackboneElement,CodeableConcept,Quantity,Range,Attachment,Count,Duration,Reference,ContactPoint,Annotation
...
class DeviceUdiCarrier(BackboneElement):
    ...
    carrierAIDC_ext: Optional[Extension] = Field(
    ...
    carrierHRF_ext: Optional[Extension] = Field(
    ...
    entryType_ext: Optional[Extension] = Field(
...
class DeviceVersion(BackboneElement):
    ...
    installDate_ext: Optional[Extension] = Field(
...
class Device(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default=Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/Device']),
    )
    ...
    displayName_ext: Optional[Extension] = Field(
    ...
    manufacturer_ext: Optional[Extension] = Field(
    ...
    manufactureDate_ext: Optional[Extension] = Field(
    ...
    serialNumber_ext: Optional[Extension] = Field(
