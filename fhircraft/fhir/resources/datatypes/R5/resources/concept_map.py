# Code autogenerated by Fhircraft 0.2.0 on 2025-09-18 11:00:38.066033.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,Coding,ContactDetail,UsageContext,CodeableConcept,Period,RelatedArtifact,BackboneElement,Quantity
...
class ConceptMapGroupElementTargetDependsOn(BackboneElement):
    ...
    attribute_ext: Optional[Extension] = Field(
...
class ConceptMapGroupElementTarget(BackboneElement):
    ...
    @field_validator(*('dependsOn', 'property_', 'comment', 'relationship', 'valueSet', 'display', 'code', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
...
class ConceptMapGroupElement(BackboneElement):
    ...
    noMap_ext: Optional[Extension] = Field(
...
class ConceptMapGroupUnmapped(BackboneElement):
    ...
    otherMap_ext: Optional[Extension] = Field(
...
class ConceptMapGroup(BackboneElement):
    ...
    target_ext: Optional[Extension] = Field(
