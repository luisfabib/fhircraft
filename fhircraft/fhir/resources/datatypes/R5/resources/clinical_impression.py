# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:27:54.563110.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,CodeableConcept,Reference,Period,BackboneElement,CodeableReference,Annotation
...
class ClinicalImpressionFinding(BackboneElement):
    ...
    @field_validator(*('basis', 'item', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
...
class ClinicalImpression(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/ClinicalImpression']),
    )
    ...
    protocol_ext: Optional[Extension] = Field(
    ...
    @field_validator(*('note', 'supportingInfo', 'prognosisReference', 'prognosisCodeableConcept', 'finding', 'summary', 'protocol', 'changePattern', 'problem', 'previous', 'performer', 'date', 'encounter', 'subject', 'description', 'statusReason', 'status', 'identifier', 'modifierExtension', 'extension', 'text', 'language', 'implicitRules', 'meta'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
