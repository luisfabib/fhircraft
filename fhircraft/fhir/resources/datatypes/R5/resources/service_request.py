# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:29:14.995712.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,Reference,CodeableConcept,CodeableReference,BackboneElement,Quantity,Ratio,Range,Period,Timing,Annotation
...
class ServiceRequestOrderDetail(BackboneElement):
    ...
    parameter: List[ServiceRequestOrderDetailParameter] = Field(
