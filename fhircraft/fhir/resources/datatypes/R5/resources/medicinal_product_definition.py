# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:28:49.605377.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,CodeableConcept,MarketingStatus,Reference,CodeableReference,BackboneElement,Coding,Period,Quantity,Attachment
...
class MedicinalProductDefinitionNamePart(BackboneElement):
    ...
    part_ext: Optional[Extension] = Field(
...
class MedicinalProductDefinitionName(BackboneElement):
    ...
    """
    productName: String = Field(
        description="The full product name",
    )
    productName_ext: Optional[Extension] = Field(
...
class MedicinalProductDefinition(FHIRBaseModel):
    ...
    indication_ext: Optional[Extension] = Field(
    ...
    name: List[MedicinalProductDefinitionName] = Field(
