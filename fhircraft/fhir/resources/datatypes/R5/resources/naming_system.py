# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 09:28:51.190379.
...
from fhircraft.fhir.resources.datatypes.R5.complex_types import Extension,Meta,Narrative,Resource,Identifier,Coding,ContactDetail,CodeableConcept,UsageContext,Period,RelatedArtifact,BackboneElement
...
class NamingSystemUniqueId(BackboneElement):
    ...
    authoritative_ext: Optional[Extension] = Field(
...
class NamingSystem(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default=Meta(versionId='5.0.0', profile=['http://hl7.org/fhir/StructureDefinition/NamingSystem']),
    )
