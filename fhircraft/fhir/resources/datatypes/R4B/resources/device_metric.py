# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:20:45.491711.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,Identifier,CodeableConcept,Reference,Timing,BackboneElement
...
class DeviceMetricCalibration(BackboneElement):
    ...
    state_ext: Optional[Extension] = Field(
...
class DeviceMetric(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='4.3.0', profile=['http://hl7.org/fhir/StructureDefinition/DeviceMetric']),
    )
    ...
    operationalStatus_ext: Optional[Extension] = Field(
    ...
    @field_validator(*('calibration', 'measurementPeriod', 'category', 'color', 'operationalStatus', 'parent', 'source', 'unit', 'type', 'identifier', 'modifierExtension', 'extension', 'text', 'language', 'implicitRules', 'meta'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
