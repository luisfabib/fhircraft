# Code autogenerated by Fhircraft 0.2.0 on 2025-09-18 11:08:32.765221.
...
class PackagedProductDefinitionPackage(BackboneElement):
    ...
    @field_validator(*('containedItem', 'property_', 'manufacturer', 'shelfLifeStorage', 'alternateMaterial', 'material', 'quantity', 'type', 'identifier', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):
        return fhir_validators.validate_element_constraint(cls, value, 
