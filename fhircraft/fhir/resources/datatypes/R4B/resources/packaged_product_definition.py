# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:21:27.664856.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,Identifier,CodeableConcept,Reference,Quantity,BackboneElement,MarketingStatus,Duration,Attachment,CodeableReference
...
class PackagedProductDefinitionPackage(BackboneElement):
    ...
    quantity_ext: Optional[Extension] = Field(
...
class PackagedProductDefinition(FHIRBaseModel):
    ...
    statusDate_ext: Optional[Extension] = Field(
    ...
    copackagedIndicator_ext: Optional[Extension] = Field(
...
PackagedProductDefinitionPackageShelfLifeStorage.model_rebuild()

PackagedProductDefinitionPackageProperty.model_rebuild()

PackagedProductDefinitionPackageContainedItem.model_rebuild()

PackagedProductDefinitionPackage.model_rebuild()
