# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:21:01.081131.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,Identifier,CodeableConcept,Reference,Annotation,DataRequirement
...
class GuidanceResponse(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='4.3.0', profile=['http://hl7.org/fhir/StructureDefinition/GuidanceResponse']),
    )
    ...
    occurrenceDateTime_ext: Optional[Extension] = Field(
    ...
    @field_validator(*('dataRequirement', 'result', 'outputParameters', 'evaluationMessage', 'note', 'reasonReference', 'reasonCode', 'performer', 'occurrenceDateTime', 'encounter', 'subject', 'status', 'identifier', 'requestIdentifier', 'modifierExtension', 'extension', 'text', 'language', 'implicitRules', 'meta'), mode="after", check_fields=None)
    @classmethod
