# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:21:12.641351.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,Identifier,Reference,Period,CodeableConcept,BackboneElement,Quantity
...
class MeasureReport(FHIRBaseModel):
    ...
    measure: Canonical = Field(
        description="What measure was calculated",
    )
    measure_ext: Optional[Extension] = Field(
