# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:21:39.312918.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,Identifier,CodeableConcept,Reference,ContactDetail,UsageContext,Period,RelatedArtifact,BackboneElement,Expression,DataRequirement,Duration,Timing
...
class ResearchElementDefinitionCharacteristic(BackboneElement):
    ...
    exclude_ext: Optional[Extension] = Field(
    ...
    studyEffectiveDescription_ext: Optional[Extension] = Field(
    ...
    studyEffectiveGroupMeasure_ext: Optional[Extension] = Field(
    ...
    participantEffectiveDescription_ext: Optional[Extension] = Field(
    ...
    participantEffectiveGroupMeasure_ext: Optional[Extension] = Field(
...
class ResearchElementDefinition(FHIRBaseModel):
    ...
    shortTitle_ext: Optional[Extension] = Field(
    ...
    variableType_ext: Optional[Extension] = Field(
