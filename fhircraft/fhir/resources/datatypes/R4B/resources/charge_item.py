# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:20:23.360014.
...
from fhircraft.fhir.resources.datatypes.primitives import String,Uri,Code,Canonical,DateTime,Decimal
 
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,Identifier,Reference,CodeableConcept,Period,Timing,BackboneElement,Quantity,Money,Annotation
...
class ChargeItem(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='4.3.0', profile=['http://hl7.org/fhir/StructureDefinition/ChargeItem']),
    )
    ...
    definitionUri_ext: Optional[Extension] = Field(
    ...
    factorOverride_ext: Optional[Extension] = Field(
    ...
    overrideReason_ext: Optional[Extension] = Field(
    ...
    enteredDate_ext: Optional[Extension] = Field(
    ...
    @field_validator(*('supportingInformation', 'note', 'account', 'service', 'reason', 'enteredDate', 'enterer', 'overrideReason', 'priceOverride', 'factorOverride', 'bodysite', 'quantity', 'costCenter', 'requestingOrganization', 'performingOrganization', 'performer', 'context', 'subject', 'code', 'partOf', 'status', 'definitionCanonical', 'definitionUri', 'identifier', 'modifierExtension', 'extension', 'text', 'language', 'implicitRules', 'meta'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
