# Code autogenerated by Fhircraft 0.2.0 on 2025-09-18 11:06:34.159518.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Identifier,BackboneElement,Resource,Signature
...
class BundleLink(BackboneElement):
    ...
    relation_ext: Optional[Extension] = Field(
...
class BundleEntryRequest(BackboneElement):
    ...
    ifNoneMatch_ext: Optional[Extension] = Field(
    ...
    ifModifiedSince_ext: Optional[Extension] = Field(
    ...
    ifMatch_ext: Optional[Extension] = Field(
    ...
    ifNoneExist_ext: Optional[Extension] = Field(
...
class BundleEntryResponse(BackboneElement):
    ...
    location_ext: Optional[Extension] = Field(
    ...
    etag_ext: Optional[Extension] = Field(
...
class BundleEntry(BackboneElement):
    ...
    fullUrl_ext: Optional[Extension] = Field(
    ...
    @field_validator(*('response', 'request', 'search', 'fullUrl', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):
        return fhir_validators.validate_element_constraint(cls, value, 
