# Code autogenerated by Fhircraft 0.2.0 on 2025-09-18 11:09:12.290180.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,Identifier,ContactDetail,UsageContext,CodeableConcept,BackboneElement,Address,Age,Annotation,Attachment,Coding,ContactPoint,Count,Distance,Duration,HumanName,Money,Period,Quantity,Range,Ratio,Reference,SampledData,Signature,Timing,Contributor,DataRequirement,Expression,ParameterDefinition,RelatedArtifact,TriggerDefinition,Dosage
...
class StructureMapGroupRuleSource(BackboneElement):
    ...
    context_ext: Optional[Extension] = Field(
    ...
    element_ext: Optional[Extension] = Field(
    ...
    listMode_ext: Optional[Extension] = Field(
    ...
    variable_ext: Optional[Extension] = Field(
    ...
    check_ext: Optional[Extension] = Field(
    ...
    logMessage_ext: Optional[Extension] = Field(
...
class StructureMapGroupRuleTarget(BackboneElement):
    ...
    contextType_ext: Optional[Extension] = Field(
    ...
    listRuleId_ext: Optional[Extension] = Field(
...
class StructureMapGroup(BackboneElement):
    ...
    extends_ext: Optional[Extension] = Field(
    ...
    typeMode_ext: Optional[Extension] = Field(
...
class StructureMap(FHIRBaseModel):
    ...
    import_ext: Optional[Extension] = Field(
