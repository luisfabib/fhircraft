# Code autogenerated by Fhircraft 0.2.0 on 2025-09-18 11:08:42.746662.
...
from fhircraft.fhir.resources.datatypes.primitives import String,Uri,Code,Boolean,Canonical,DateTime,Markdown,Date,Id
 
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,Identifier,CodeableConcept,Reference,ContactDetail,UsageContext,Period,RelatedArtifact,BackboneElement,Quantity,Range,Duration,TriggerDefinition,Expression,DataRequirement,Age,Timing
...
class PlanDefinitionActionRelatedAction(BackboneElement):
    ...
    actionId_ext: Optional[Extension] = Field(
...
class PlanDefinitionAction(BackboneElement):
    ...
    @field_validator(*('dynamicValue', 'transform', 'cardinalityBehavior', 'precheckBehavior', 'requiredBehavior', 'selectionBehavior', 'groupingBehavior', 'type', 'participant', 'relatedAction', 'output', 'input', 'condition', 'trigger', 'goalId', 'documentation', 'reason', 'code', 'priority', 'textEquivalent', 'description', 'title', 'prefix', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count()) or $this is Parameters",
