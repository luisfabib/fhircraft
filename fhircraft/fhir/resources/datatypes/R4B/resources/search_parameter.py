# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:21:41.724798.
...
class SearchParameter(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='4.3.0', profile=['http://hl7.org/fhir/StructureDefinition/SearchParameter']),
    )
    ...
    xpath_ext: Optional[Extension] = Field(
    ...
    xpathUsage_ext: Optional[Extension] = Field(
