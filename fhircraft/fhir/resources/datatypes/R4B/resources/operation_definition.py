# Code autogenerated by Fhircraft 0.2.0 on 2025-09-18 11:08:27.832347.
...
class OperationDefinitionParameterBinding(BackboneElement):
    ...
    strength_ext: Optional[Extension] = Field(
        description="Placeholder element for strength extensions",
        default=None,
        alias="_strength",
    )
    valueSet: Canonical = Field(
...
class OperationDefinitionParameterReferencedFrom(BackboneElement):
    ...
    source_ext: Optional[Extension] = Field(
...
class OperationDefinitionParameter(BackboneElement):
    ...
    targetProfile_ext: Optional[Extension] = Field(
    ...
    searchType_ext: Optional[Extension] = Field(
    ...
    @field_validator(*('referencedFrom', 'binding', 'searchType', 'targetProfile', 'type', 'documentation', 'max', 'min', 'use', 'name', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):
        return fhir_validators.validate_element_constraint(cls, value, 
...
class OperationDefinitionOverload(BackboneElement):
    ...
    parameterName_ext: Optional[Extension] = Field(
...
class OperationDefinition(FHIRBaseModel):
    ...
    affectsState_ext: Optional[Extension] = Field(
    ...
    base_ext: Optional[Extension] = Field(
    ...
    inputProfile_ext: Optional[Extension] = Field(
    ...
    outputProfile_ext: Optional[Extension] = Field(
