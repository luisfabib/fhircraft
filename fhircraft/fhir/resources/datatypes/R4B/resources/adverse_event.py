# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:20:12.390081.
...
class AdverseEventSuspectEntityCausality(BackboneElement):
    ...
    productRelatedness_ext: Optional[Extension] = Field(
...
class AdverseEvent(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='4.3.0', profile=['http://hl7.org/fhir/StructureDefinition/AdverseEvent']),
    )
