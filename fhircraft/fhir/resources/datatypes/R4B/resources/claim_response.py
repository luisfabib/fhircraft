# Code autogenerated by Fhircraft 0.2.0 on 2025-09-18 11:06:51.772551.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,Identifier,CodeableConcept,Reference,Period,BackboneElement,Money,Address,Quantity,Attachment
...
class ClaimResponseItemDetailSubDetail(BackboneElement):
    ...
    @field_validator(*('noteNumber', 'subDetailSequence', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
...
class ClaimResponseItemDetail(BackboneElement):
    ...
    @field_validator(*('subDetail', 'noteNumber', 'detailSequence', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):
        return fhir_validators.validate_element_constraint(cls, value, 
