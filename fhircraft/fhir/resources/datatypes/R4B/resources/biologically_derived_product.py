# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:20:16.271367.
...
class BiologicallyDerivedProductStorage(BackboneElement):
    ...
    temperature_ext: Optional[Extension] = Field(
    ...
    scale_ext: Optional[Extension] = Field(
...
into another (possibly the same) biological entity.
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='4.3.0', profile=['http://hl7.org/fhir/StructureDefinition/BiologicallyDerivedProduct']),
    )
    ...
    productCategory_ext: Optional[Extension] = Field(
