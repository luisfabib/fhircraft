# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:21:24.852640.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,CodeableConcept,Identifier,BackboneElement,Range,Reference
...
class ObservationDefinitionQuantitativeDetails(BackboneElement):
    ...
    conversionFactor_ext: Optional[Extension] = Field(
    ...
    decimalPrecision_ext: Optional[Extension] = Field(
...
class ObservationDefinition(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='4.3.0', profile=['http://hl7.org/fhir/StructureDefinition/ObservationDefinition']),
    )
