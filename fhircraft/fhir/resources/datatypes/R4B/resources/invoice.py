# Code autogenerated by Fhircraft 0.2.0 on 2025-09-18 11:07:53.141189.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,Identifier,CodeableConcept,Reference,BackboneElement,Money,Annotation
...
class Invoice(FHIRBaseModel):
    ...
    @field_validator(*('note', 'paymentTerms', 'totalGross', 'totalNet', 'lineItem', 'account', 'issuer', 'participant', 'date', 'recipient', 'subject', 'type', 'cancelledReason', 'status', 'identifier', 'modifierExtension', 'extension', 'text', 'language', 'implicitRules', 'meta'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
