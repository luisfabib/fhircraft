# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:21:08.384645.
...
class Invoice(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='4.3.0', profile=['http://hl7.org/fhir/StructureDefinition/Invoice']),
    )
    ...
    totalPriceComponent: Optional[List[InvoiceLineItemPriceComponent]] = Field(
