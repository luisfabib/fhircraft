# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 09:30:35.154227.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,Identifier,BackboneElement,Reference,CodeableConcept,ProductShelfLife,ProdCharacteristic,Quantity,ContactPoint,Annotation
...
class DeviceDefinition(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default=Meta(versionId='4.3.0', profile=['http://hl7.org/fhir/StructureDefinition/DeviceDefinition']),
    )
    ...
    onlineInformation_ext: Optional[Extension] = Field(
