# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 09:31:08.242570.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,Identifier,CodeableConcept,MarketingStatus,CodeableReference,Reference,BackboneElement,Coding,Period,Quantity,Attachment
...
class MedicinalProductDefinition(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default=Meta(versionId='4.3.0', profile=['http://hl7.org/fhir/StructureDefinition/MedicinalProductDefinition']),
    )
...
MedicinalProductDefinitionNameNamePart.model_rebuild()

MedicinalProductDefinitionNameCountryLanguage.model_rebuild()
