# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:21:11.716577.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,Identifier,CodeableConcept,Reference,ContactDetail,UsageContext,Period,RelatedArtifact,BackboneElement,Expression
...
class Measure(FHIRBaseModel):
    ...
    disclaimer_ext: Optional[Extension] = Field(
    ...
    riskAdjustment_ext: Optional[Extension] = Field(
    ...
    rateAggregation_ext: Optional[Extension] = Field(
    ...
    rationale_ext: Optional[Extension] = Field(
    ...
    clinicalRecommendationStatement_ext: Optional[Extension] = Field(
    ...
    guidance_ext: Optional[Extension] = Field(
