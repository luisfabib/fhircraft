# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:21:20.031364.
...
from fhircraft.fhir.resources.datatypes.primitives import String,Uri,Code,Url,Id,Canonical
 
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,Coding,BackboneElement,Reference,ContactPoint,CodeableConcept
...
class MessageHeaderDestination(BackboneElement):
    ...
    endpoint_ext: Optional[Extension] = Field(
    ...
    @field_validator(*('receiver', 'endpoint', 'target', 'name', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
...
class MessageHeaderSource(BackboneElement):
    ...
    software_ext: Optional[Extension] = Field(
    ...
    @field_validator(*('endpoint', 'contact', 'version', 'software', 'name', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
...
class MessageHeader(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='4.3.0', profile=['http://hl7.org/fhir/StructureDefinition/MessageHeader']),
    )
    ...
    @field_validator(*('definition', 'focus', 'response', 'reason', 'responsible', 'source', 'author', 'enterer', 'sender', 'destination', 'modifierExtension', 'extension', 'text', 'language', 'implicitRules', 'meta'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
