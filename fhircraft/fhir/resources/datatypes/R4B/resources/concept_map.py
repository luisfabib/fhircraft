# Code autogenerated by Fhircraft 0.2.0 on 2025-09-18 11:07:00.989490.
...
class ConceptMapGroupElementTarget(BackboneElement):
    ...
    @field_validator(*('dependsOn', 'comment', 'equivalence', 'display', 'code', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):
        return fhir_validators.validate_element_constraint(cls, value, 
...
class ConceptMapGroup(BackboneElement):
    ...
    sourceVersion_ext: Optional[Extension] = Field(
    ...
    targetVersion_ext: Optional[Extension] = Field(
