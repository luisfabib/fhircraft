# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:21:41.115497.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,Identifier,CodeableConcept,Reference,Period
...
class Schedule(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='4.3.0', profile=['http://hl7.org/fhir/StructureDefinition/Schedule']),
    )
    ...
    @field_validator(*('comment', 'planningHorizon', 'actor', 'specialty', 'serviceType', 'serviceCategory', 'active', 'identifier', 'modifierExtension', 'extension', 'text', 'language', 'implicitRules', 'meta'), mode="after", check_fields=None)
    @classmethod
