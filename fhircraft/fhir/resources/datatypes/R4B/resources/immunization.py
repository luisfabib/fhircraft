# Code autogenerated by Fhircraft 0.2.0 on 2025-09-18 11:07:46.089620.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,Identifier,CodeableConcept,Reference,Quantity,BackboneElement,Annotation
...
class ImmunizationEducation(BackboneElement):
    ...
    documentType_ext: Optional[Extension] = Field(
    ...
    reference_ext: Optional[Extension] = Field(
    ...
    presentationDate_ext: Optional[Extension] = Field(
...
class ImmunizationReaction(BackboneElement):
    ...
    reported_ext: Optional[Extension] = Field(
...
class ImmunizationProtocolApplied(BackboneElement):
    ...
    series_ext: Optional[Extension] = Field(
    ...
    doseNumberPositiveInt: PositiveInt = Field(
        description="Dose number within series",
    )
    doseNumberString: String = Field(
        description="Dose number within series",
    )
...
class Immunization(FHIRBaseModel):
    ...
    occurrenceDateTime: DateTime = Field(
        description="Vaccine administration date",
    )
    occurrenceString: String = Field(
        description="Vaccine administration date",
    )
    ...
    recorded_ext: Optional[Extension] = Field(
    ...
    primarySource_ext: Optional[Extension] = Field(
    ...
    isSubpotent_ext: Optional[Extension] = Field(
