# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:20:47.161339.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,Identifier,Reference,CodeableConcept,Period,BackboneElement,Attachment
...
class DiagnosticReport(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='4.3.0', profile=['http://hl7.org/fhir/StructureDefinition/DiagnosticReport']),
    )
    ...
    conclusion_ext: Optional[Extension] = Field(
    ...
    @field_validator(*('presentedForm', 'conclusionCode', 'conclusion', 'media', 'imagingStudy', 'result', 'specimen', 'resultsInterpreter', 'performer', 'issued', 'encounter', 'subject', 'code', 'category', 'status', 'basedOn', 'identifier', 'modifierExtension', 'extension', 'text', 'language', 'implicitRules', 'meta'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
