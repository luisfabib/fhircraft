# Code autogenerated by Fhircraft 0.2.0 on 2025-09-18 11:09:27.786410.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,Identifier,ContactDetail,UsageContext,CodeableConcept,BackboneElement,Coding
...
class ValueSetCompose(BackboneElement):
    ...
    @field_validator(*('include', 'inactive', 'lockedDate', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count()) or $this is Parameters",
...
class ValueSetExpansionContains(BackboneElement):
    ...
    @field_validator(*('display', 'code', 'version', 'inactive', 'abstract', 'system', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
