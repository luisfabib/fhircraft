# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:20:49.991133.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,Identifier,Coding,Reference,ContactPoint,Period,CodeableConcept
...
class Endpoint(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='4.3.0', profile=['http://hl7.org/fhir/StructureDefinition/Endpoint']),
    )
    ...
    payloadType: List[CodeableConcept] = Field(
    ...
    payloadMimeType_ext: Optional[Extension] = Field(
    ...
    @field_validator(*('header', 'address', 'payloadMimeType', 'payloadType', 'period', 'contact', 'managingOrganization', 'name', 'connectionType', 'status', 'identifier', 'modifierExtension', 'extension', 'text', 'language', 'implicitRules', 'meta'), mode="after", check_fields=None)
    @classmethod
