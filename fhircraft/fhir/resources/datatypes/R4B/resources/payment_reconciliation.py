# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:21:30.343306.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,Identifier,Period,Reference,Money,BackboneElement,CodeableConcept
...
class PaymentReconciliationDetail(BackboneElement):
    ...
    @field_validator(*('amount', 'payee', 'responsible', 'date', 'response', 'submitter', 'request', 'type', 'predecessor', 'identifier', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
...
class PaymentReconciliation(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='4.3.0', profile=['http://hl7.org/fhir/StructureDefinition/PaymentReconciliation']),
    )
    ...
    @field_validator(*('processNote', 'formCode', 'detail', 'paymentIdentifier', 'paymentAmount', 'paymentDate', 'disposition', 'outcome', 'requestor', 'request', 'paymentIssuer', 'created', 'period', 'status', 'identifier', 'modifierExtension', 'extension', 'text', 'language', 'implicitRules', 'meta'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
