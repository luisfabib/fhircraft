# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:21:23.186498.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,CodeableConcept,Reference,BackboneElement,CodeableReference,Ratio,Quantity,Attachment,Identifier,Annotation
...
class NutritionProductInstance(BackboneElement):
    ...
    useBy_ext: Optional[Extension] = Field(
...
NutritionProductProductCharacteristic.model_rebuild()
