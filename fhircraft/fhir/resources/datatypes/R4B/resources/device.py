# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:20:44.364544.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,Identifier,Reference,BackboneElement,CodeableConcept,Quantity,ContactPoint,Annotation
...
class Device(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='4.3.0', profile=['http://hl7.org/fhir/StructureDefinition/Device']),
    )
    ...
    distinctIdentifier_ext: Optional[Extension] = Field(
