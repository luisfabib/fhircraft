# Code autogenerated by Fhircraft 0.2.0 on 2025-09-18 11:07:39.467875.
...
class GraphDefinitionLinkTarget(BackboneElement):
    ...
    @field_validator(*('compartment', 'profile', 'params', 'type', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):
        return fhir_validators.validate_element_constraint(cls, value, 
