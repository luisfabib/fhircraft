# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:21:00.365698.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,ContactDetail,UsageContext,CodeableConcept,BackboneElement
...
class GraphDefinitionLinkTargetCompartment(BackboneElement):
    ...
    rule_ext: Optional[Extension] = Field(
...
class GraphDefinitionLink(FHIRBaseModel):
    """
    ...
    @field_validator(*('target', 'description', 'max', 'min', 'sliceName', 'path', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
...
class GraphDefinition(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='4.3.0', profile=['http://hl7.org/fhir/StructureDefinition/GraphDefinition']),
    )
    ...
    start_ext: Optional[Extension] = Field(
