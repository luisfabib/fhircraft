# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 09:30:44.167033.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,Identifier,Annotation,UsageContext,ContactDetail,RelatedArtifact,BackboneElement,Reference,CodeableConcept,Expression,Quantity,Range
...
class EvidenceVariable(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default=Meta(versionId='4.3.0', profile=['http://hl7.org/fhir/StructureDefinition/EvidenceVariable']),
    )
    ...
    characteristicCombination_ext: Optional[Extension] = Field(
...
EvidenceVariableCharacteristicTimeFromStart.model_rebuild()
