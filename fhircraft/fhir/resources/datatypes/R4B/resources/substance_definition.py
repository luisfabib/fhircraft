# Code autogenerated by Fhircraft 0.2.0 on 2025-09-18 11:09:18.105306.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,Identifier,CodeableConcept,Reference,Annotation,BackboneElement,Quantity,Attachment,Ratio
...
class SubstanceDefinitionMoiety(BackboneElement):
    ...
    molecularFormula_ext: Optional[Extension] = Field(
...
class SubstanceDefinitionStructure(BackboneElement):
    ...
    molecularFormulaByMoiety_ext: Optional[Extension] = Field(
...
class SubstanceDefinitionRelationship(BackboneElement):
    ...
    isDefining_ext: Optional[Extension] = Field(
...
class SubstanceDefinition(FHIRBaseModel):
    ...
    @field_validator(*('sourceMaterial', 'relationship', 'name', 'code', 'structure', 'molecularWeight', 'property_', 'moiety', 'supplier', 'manufacturer', 'note', 'informationSource', 'description', 'grade', 'domain', 'classification', 'status', 'version', 'identifier', 'modifierExtension', 'extension', 'text', 'language', 'implicitRules', 'meta'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count()) or $this is Parameters",
