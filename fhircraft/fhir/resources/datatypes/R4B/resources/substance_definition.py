# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:21:49.931530.
...
class SubstanceDefinitionStructure(BackboneElement):
    ...
    molecularWeight: Optional[SubstanceDefinitionMolecularWeight] = Field(
...
class SubstanceDefinition(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='4.3.0', profile=['http://hl7.org/fhir/StructureDefinition/SubstanceDefinition']),
    )
