# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:21:29.245977.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,Identifier,HumanName,ContactPoint,Address,CodeableConcept,Attachment,BackboneElement,Reference,Period
...
class Patient(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='4.3.0', profile=['http://hl7.org/fhir/StructureDefinition/Patient']),
    )
