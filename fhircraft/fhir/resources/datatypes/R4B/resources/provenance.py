# Code autogenerated by Fhircraft 0.2.0 on 2025-09-18 11:08:47.853496.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,Reference,Period,CodeableConcept,BackboneElement,Signature
...
class ProvenanceEntity(BackboneElement):
    ...
    @field_validator(*('what', 'role', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
