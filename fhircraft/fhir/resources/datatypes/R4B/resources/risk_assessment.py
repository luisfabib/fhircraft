# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:21:40.822534.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,Identifier,Reference,CodeableConcept,Period,BackboneElement,Range,Annotation
...
class RiskAssessmentPrediction(BackboneElement):
    ...
    relativeRisk_ext: Optional[Extension] = Field(
...
class RiskAssessment(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='4.3.0', profile=['http://hl7.org/fhir/StructureDefinition/RiskAssessment']),
    )
    ...
    mitigation_ext: Optional[Extension] = Field(
    ...
    @field_validator(*('note', 'mitigation', 'prediction', 'basis', 'reasonReference', 'reasonCode', 'performer', 'condition', 'encounter', 'subject', 'code', 'method', 'status', 'parent', 'basedOn', 'identifier', 'modifierExtension', 'extension', 'text', 'language', 'implicitRules', 'meta'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
