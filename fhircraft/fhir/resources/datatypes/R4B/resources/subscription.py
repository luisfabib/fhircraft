# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:21:46.626632.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,ContactPoint,BackboneElement
...
class SubscriptionChannel(BackboneElement):
    ...
    payload_ext: Optional[Extension] = Field(
    ...
    header_ext: Optional[Extension] = Field(
...
class Subscription(FHIRBaseModel):
    ...
    criteria_ext: Optional[Extension] = Field(
    ...
    error_ext: Optional[Extension] = Field(
