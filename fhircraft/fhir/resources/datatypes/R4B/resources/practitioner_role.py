# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:21:33.241100.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,Identifier,Period,Reference,CodeableConcept,ContactPoint,BackboneElement
...
class PractitionerRoleAvailableTime(BackboneElement):
    ...
    daysOfWeek_ext: Optional[Extension] = Field(
    ...
    allDay_ext: Optional[Extension] = Field(
    ...
    availableStartTime_ext: Optional[Extension] = Field(
    ...
    availableEndTime_ext: Optional[Extension] = Field(
...
class PractitionerRole(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='4.3.0', profile=['http://hl7.org/fhir/StructureDefinition/PractitionerRole']),
    )
    ...
    availabilityExceptions_ext: Optional[Extension] = Field(
