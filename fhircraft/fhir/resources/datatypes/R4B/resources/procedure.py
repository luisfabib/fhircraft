# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 09:31:23.159204.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,Identifier,Reference,CodeableConcept,Period,Age,Range,BackboneElement,Annotation
...
class Procedure(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default=Meta(versionId='4.3.0', profile=['http://hl7.org/fhir/StructureDefinition/Procedure']),
    )
