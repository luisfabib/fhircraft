# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 09:30:45.048611.
...
class ExampleScenarioProcessStep(BackboneElement):
    ...
    """
    process: Optional[List[Any]] = Field(
...
class ExampleScenario(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default=Meta(versionId='4.3.0', profile=['http://hl7.org/fhir/StructureDefinition/ExampleScenario']),
    )
