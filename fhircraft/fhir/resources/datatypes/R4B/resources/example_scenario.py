# Code autogenerated by Fhircraft 0.2.0 on 2025-09-18 11:07:33.375654.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,Identifier,ContactDetail,UsageContext,CodeableConcept,BackboneElement
...
class ExampleScenarioInstanceContainedInstance(BackboneElement):
    ...
    """
    resourceId: String = Field(
        description="Each resource contained in the instance",
    )
    resourceId_ext: Optional[Extension] = Field(
...
class ExampleScenarioInstance(BackboneElement):
    ...
    resourceType: Code = Field(
        description="The type of the resource",
    )
    resourceType_ext: Optional[Extension] = Field(
...
class ExampleScenarioProcessStepOperation(BackboneElement):
    ...
    @field_validator(*('receiverActive', 'initiatorActive', 'description', 'receiver', 'initiator', 'name', 'type', 'number', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
...
class ExampleScenarioProcessStep(BackboneElement):
    ...
    @field_validator(*('alternative', 'operation', 'pause', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count()) or $this is Parameters",
