# Code autogenerated by Fhircraft 0.2.0 on 2025-09-18 11:07:48.327792.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,ContactDetail,UsageContext,CodeableConcept,BackboneElement,Reference
...
class ImplementationGuideDefinitionPage(BackboneElement):
    ...
    @field_validator(*('generation', 'title', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
