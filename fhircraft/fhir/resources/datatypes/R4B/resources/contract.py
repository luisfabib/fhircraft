# Code autogenerated by Fhircraft 0.2.0 on 2025-09-18 11:07:05.224236.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,Identifier,CodeableConcept,Reference,Period,BackboneElement,Coding,Attachment,Quantity,Money,Timing,Annotation,Signature
...
class ContractTermAction(BackboneElement):
    ...
    reason_ext: Optional[Extension] = Field(
