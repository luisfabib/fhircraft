# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:20:34.805203.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,Identifier,Reference,CodeableConcept,BackboneElement,Attachment,Period,Annotation
...
class CommunicationRequest(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='4.3.0', profile=['http://hl7.org/fhir/StructureDefinition/CommunicationRequest']),
    )
    ...
    @field_validator(*('note', 'reasonReference', 'reasonCode', 'sender', 'recipient', 'requester', 'authoredOn', 'payload', 'encounter', 'about', 'subject', 'medium', 'doNotPerform', 'priority', 'category', 'statusReason', 'status', 'groupIdentifier', 'replaces', 'basedOn', 'identifier', 'modifierExtension', 'extension', 'text', 'language', 'implicitRules', 'meta'), mode="after", check_fields=None)
    @classmethod
