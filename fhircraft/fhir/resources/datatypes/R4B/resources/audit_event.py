# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:20:15.189476.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,Coding,Period,CodeableConcept,BackboneElement,Reference
...
class AuditEventAgent(BackboneElement):
    ...
    altId_ext: Optional[Extension] = Field(
    ...
    requestor: Boolean = Field(
        description="Whether user is initiator",
    )
    requestor_ext: Optional[Extension] = Field(
    ...
    policy_ext: Optional[Extension] = Field(
...
class AuditEventSource(BackboneElement):
    ...
    site_ext: Optional[Extension] = Field(
...
class AuditEventEntity(BackboneElement):
    ...
    query_ext: Optional[Extension] = Field(
...
class AuditEvent(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='4.3.0', profile=['http://hl7.org/fhir/StructureDefinition/AuditEvent']),
    )
    ...
    action_ext: Optional[Extension] = Field(
    ...
    outcomeDesc_ext: Optional[Extension] = Field(
