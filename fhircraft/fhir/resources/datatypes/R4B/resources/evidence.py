# Code autogenerated by Fhircraft 0.2.0 on 2025-09-18 11:07:30.107469.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,Identifier,Reference,UsageContext,ContactDetail,RelatedArtifact,Annotation,BackboneElement,CodeableConcept,Quantity,Range
...
class EvidenceStatisticSampleSize(BackboneElement):
    ...
    numberOfStudies_ext: Optional[Extension] = Field(
    ...
    numberOfParticipants_ext: Optional[Extension] = Field(
    ...
    knownDataCount_ext: Optional[Extension] = Field(
...
class EvidenceStatisticAttributeEstimate(BackboneElement):
    ...
    level_ext: Optional[Extension] = Field(
    ...
    @field_validator(*('range', 'level', 'quantity', 'type', 'note', 'description', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
...
class EvidenceStatisticModelCharacteristicVariable(BackboneElement):
    ...
    handling_ext: Optional[Extension] = Field(
...
class EvidenceStatisticModelCharacteristic(BackboneElement):
    ...
    @field_validator(*('variable', 'value', 'code', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):
        return fhir_validators.validate_element_constraint(cls, value, 
...
class EvidenceStatistic(BackboneElement):
    ...
    numberOfEvents_ext: Optional[Extension] = Field(
    ...
    numberAffected_ext: Optional[Extension] = Field(
...
class EvidenceCertainty(BackboneElement):
    ...
    rater_ext: Optional[Extension] = Field(
        description="Placeholder element for rater extensions",
        default=None,
        alias="_rater",
    )
    @field_validator(*('rater', 'rating', 'type', 'note', 'description', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
...
class Evidence(FHIRBaseModel):
    ...
    assertion_ext: Optional[Extension] = Field(
    ...
    variableDefinition: List[EvidenceVariableDefinition] = Field(
