# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:21:40.253054.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,Identifier,Period,Reference
...
class ResearchSubject(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='4.3.0', profile=['http://hl7.org/fhir/StructureDefinition/ResearchSubject']),
    )
    ...
    assignedArm_ext: Optional[Extension] = Field(
    ...
    actualArm_ext: Optional[Extension] = Field(
    ...
    @field_validator(*('consent', 'actualArm', 'assignedArm', 'individual', 'study', 'period', 'status', 'identifier', 'modifierExtension', 'extension', 'text', 'language', 'implicitRules', 'meta'), mode="after", check_fields=None)
    @classmethod
