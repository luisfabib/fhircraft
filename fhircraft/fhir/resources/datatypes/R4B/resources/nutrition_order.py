# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:21:22.631496.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,Identifier,Reference,CodeableConcept,BackboneElement,Timing,Quantity,Ratio,Annotation
...
class NutritionOrderEnteralFormula(BackboneElement):
    ...
    additiveProductName_ext: Optional[Extension] = Field(
...
class NutritionOrder(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='4.3.0', profile=['http://hl7.org/fhir/StructureDefinition/NutritionOrder']),
    )
