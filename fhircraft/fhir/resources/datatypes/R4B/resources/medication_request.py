# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 09:31:06.669830.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,Identifier,CodeableConcept,Reference,Annotation,Dosage,BackboneElement,Quantity,Duration,Period
...
class MedicationRequest(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default=Meta(versionId='4.3.0', profile=['http://hl7.org/fhir/StructureDefinition/MedicationRequest']),
    )
