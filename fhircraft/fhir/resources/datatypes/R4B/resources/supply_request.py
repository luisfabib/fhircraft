# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:21:50.784956.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,Identifier,CodeableConcept,Reference,Quantity,BackboneElement,Range,Period,Timing
...
class SupplyRequest(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='4.3.0', profile=['http://hl7.org/fhir/StructureDefinition/SupplyRequest']),
    )
    ...
    @field_validator(*('deliverTo', 'deliverFrom', 'reasonReference', 'reasonCode', 'supplier', 'requester', 'authoredOn', 'parameter', 'quantity', 'priority', 'category', 'status', 'identifier', 'modifierExtension', 'extension', 'text', 'language', 'implicitRules', 'meta'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
