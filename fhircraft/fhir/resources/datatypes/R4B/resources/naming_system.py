# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:21:21.601917.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,ContactDetail,CodeableConcept,UsageContext,BackboneElement,Period
...
class NamingSystemUniqueId(BackboneElement):
    ...
    preferred_ext: Optional[Extension] = Field(
...
class NamingSystem(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='4.3.0', profile=['http://hl7.org/fhir/StructureDefinition/NamingSystem']),
    )
    ...
    uniqueId: List[NamingSystemUniqueId] = Field(
