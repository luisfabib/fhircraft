# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 09:31:05.769793.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,CodeableConcept,Reference,Quantity,BackboneElement,Ratio,Money,Dosage,Duration
...
class MedicationKnowledge(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default=Meta(versionId='4.3.0', profile=['http://hl7.org/fhir/StructureDefinition/MedicationKnowledge']),
    )
    ...
    synonym_ext: Optional[Extension] = Field(
    ...
    preparationInstruction_ext: Optional[Extension] = Field(
