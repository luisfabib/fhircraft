# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:20:12.981917.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,Identifier,CodeableConcept,Reference,Age,Period,Range,Annotation,BackboneElement
...
class AllergyIntoleranceReaction(BackboneElement):
    ...
    onset_ext: Optional[Extension] = Field(
...
class AllergyIntolerance(FHIRBaseModel):
    ...
    criticality_ext: Optional[Extension] = Field(
    ...
    recordedDate_ext: Optional[Extension] = Field(
    ...
    lastOccurrence_ext: Optional[Extension] = Field(
