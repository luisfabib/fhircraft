# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:21:13.195093.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,Identifier,Reference,CodeableConcept,Period,Attachment,Annotation
...
class Media(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='4.3.0', profile=['http://hl7.org/fhir/StructureDefinition/Media']),
    )
    ...
    deviceName_ext: Optional[Extension] = Field(
    ...
    height_ext: Optional[Extension] = Field(
    ...
    width_ext: Optional[Extension] = Field(
    ...
    frames_ext: Optional[Extension] = Field(
    ...
    duration_ext: Optional[Extension] = Field(
