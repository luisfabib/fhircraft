# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:21:57.450478.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,Reference,CodeableConcept,Timing,BackboneElement,Signature
...
class VerificationResultPrimarySource(BackboneElement):
    ...
    validationDate_ext: Optional[Extension] = Field(
...
class VerificationResultAttestation(BackboneElement):
    ...
    sourceIdentityCertificate_ext: Optional[Extension] = Field(
    ...
    proxyIdentityCertificate_ext: Optional[Extension] = Field(
...
class VerificationResultValidator(BackboneElement):
    ...
    identityCertificate_ext: Optional[Extension] = Field(
...
class VerificationResult(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='4.3.0', profile=['http://hl7.org/fhir/StructureDefinition/VerificationResult']),
    )
    ...
    targetLocation_ext: Optional[Extension] = Field(
    ...
    lastPerformed_ext: Optional[Extension] = Field(
    ...
    nextScheduled_ext: Optional[Extension] = Field(
