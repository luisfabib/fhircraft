# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:21:29.810012.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,Identifier,Reference,Money,CodeableConcept
...
class PaymentNotice(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='4.3.0', profile=['http://hl7.org/fhir/StructureDefinition/PaymentNotice']),
    )
