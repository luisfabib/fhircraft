# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:20:21.178677.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,Identifier,CodeableConcept,Reference,Period,BackboneElement,ContactPoint,Annotation
...
class CareTeamParticipant(BackboneElement):
    ...
    @field_validator(*('period', 'onBehalfOf', 'member', 'role', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
...
class CareTeam(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='4.3.0', profile=['http://hl7.org/fhir/StructureDefinition/CareTeam']),
    )
    ...
    @field_validator(*('note', 'telecom', 'managingOrganization', 'reasonReference', 'reasonCode', 'participant', 'period', 'encounter', 'subject', 'name', 'category', 'status', 'identifier', 'modifierExtension', 'extension', 'text', 'language', 'implicitRules', 'meta'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
