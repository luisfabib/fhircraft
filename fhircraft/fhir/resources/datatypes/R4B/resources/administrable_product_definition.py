# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:20:11.778535.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,Identifier,Reference,CodeableConcept,BackboneElement,Quantity,Attachment,Ratio,Duration
...
class AdministrableProductDefinitionRouteOfAdministrationTargetSpeciesWithdrawalPeriod(BackboneElement):
    ...
    supportingInformation_ext: Optional[Extension] = Field(
...
class AdministrableProductDefinition(FHIRBaseModel):
    ...
    routeOfAdministration: List[AdministrableProductDefinitionRouteOfAdministration] = Field(
