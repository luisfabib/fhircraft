# Code autogenerated by Fhircraft 0.2.0 on 2025-09-18 11:07:02.708239.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,Identifier,CodeableConcept,Reference,Attachment,BackboneElement,Period,Coding
...
class ConsentPolicy(BackboneElement):
    ...
    authority_ext: Optional[Extension] = Field(
...
class ConsentVerification(BackboneElement):
    ...
    verified_ext: Optional[Extension] = Field(
    ...
    verificationDate_ext: Optional[Extension] = Field(
...
class ConsentProvision(BackboneElement):
    ...
    @field_validator(*('data', 'dataPeriod', 'code', 'class_', 'purpose', 'securityLabel', 'action', 'actor', 'period', 'type', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):
        return fhir_validators.validate_element_constraint(cls, value, 
