# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:20:58.907254.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,Identifier,CodeableConcept,Reference,Period,Age,Range,Annotation,BackboneElement
...
class FamilyMemberHistory(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='4.3.0', profile=['http://hl7.org/fhir/StructureDefinition/FamilyMemberHistory']),
    )
