# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 09:30:57.307974.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,Identifier,CodeableConcept,Period,Reference,BackboneElement,HumanName,ContactPoint,Address,Quantity,Money
...
class InsurancePlan(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default=Meta(versionId='4.3.0', profile=['http://hl7.org/fhir/StructureDefinition/InsurancePlan']),
    )
