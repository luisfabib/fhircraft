# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:20:32.741329.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,Identifier,CodeableConcept,Reference,BackboneElement,CodeableReference,Range
...
class ClinicalUseDefinitionContraindicationOtherTherapy(BackboneElement):
    ...
    @field_validator(*('therapy', 'relationshipType', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
...
class ClinicalUseDefinitionContraindication(BackboneElement):
    ...
    @field_validator(*('otherTherapy', 'indication', 'comorbidity', 'diseaseStatus', 'diseaseSymptomProcedure', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
...
class ClinicalUseDefinitionIndication(BackboneElement):
    ...
    @field_validator(*('otherTherapy', 'undesirableEffect', 'intendedEffect', 'comorbidity', 'diseaseStatus', 'diseaseSymptomProcedure', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
...
class ClinicalUseDefinition(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='4.3.0', profile=['http://hl7.org/fhir/StructureDefinition/ClinicalUseDefinition']),
    )
    ...
    @field_validator(*('warning', 'undesirableEffect', 'population', 'interaction', 'indication', 'contraindication', 'status', 'subject', 'category', 'type', 'identifier', 'modifierExtension', 'extension', 'text', 'language', 'implicitRules', 'meta'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count()) or $this is Parameters",
