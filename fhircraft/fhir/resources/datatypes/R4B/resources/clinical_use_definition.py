# Code autogenerated by Fhircraft 0.2.0 on 2025-09-18 11:06:53.488313.
...
class ClinicalUseDefinitionIndication(BackboneElement):
    ...
    @field_validator(*('undesirableEffect', 'intendedEffect', 'comorbidity', 'diseaseStatus', 'diseaseSymptomProcedure', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
