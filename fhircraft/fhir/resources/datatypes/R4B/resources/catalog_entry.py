# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:20:22.073395.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,Identifier,CodeableConcept,Reference,Period,BackboneElement
...
class CatalogEntryRelatedEntry(BackboneElement):
    ...
    """
    relationtype: Code = Field(
        description="triggers | is-replaced-by",
    )
    relationtype_ext: Optional[Extension] = Field(
...
class CatalogEntry(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='4.3.0', profile=['http://hl7.org/fhir/StructureDefinition/CatalogEntry']),
    )
    ...
    orderable: Boolean = Field(
        description="Whether the entry represents an orderable item",
    )
    orderable_ext: Optional[Extension] = Field(
    ...
    validTo_ext: Optional[Extension] = Field(
    ...
    lastUpdated_ext: Optional[Extension] = Field(
