# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:21:57.980809.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,Identifier,Reference,BackboneElement,CodeableConcept,Quantity,Annotation
...
class VisionPrescriptionLensSpecificationPrism(BackboneElement):
    ...
    amount_ext: Optional[Extension] = Field(
...
class VisionPrescriptionLensSpecification(BackboneElement):
    ...
    eye_ext: Optional[Extension] = Field(
    ...
    sphere_ext: Optional[Extension] = Field(
    ...
    cylinder_ext: Optional[Extension] = Field(
    ...
    axis_ext: Optional[Extension] = Field(
    ...
    add_ext: Optional[Extension] = Field(
    ...
    power_ext: Optional[Extension] = Field(
    ...
    backCurve_ext: Optional[Extension] = Field(
    ...
    diameter_ext: Optional[Extension] = Field(
    ...
    color_ext: Optional[Extension] = Field(
    ...
    brand_ext: Optional[Extension] = Field(
...
class VisionPrescription(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='4.3.0', profile=['http://hl7.org/fhir/StructureDefinition/VisionPrescription']),
    )
    ...
    dateWritten_ext: Optional[Extension] = Field(
    ...
    lensSpecification: List[VisionPrescriptionLensSpecification] = Field(
