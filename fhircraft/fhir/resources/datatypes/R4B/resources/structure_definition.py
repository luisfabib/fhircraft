# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:21:44.933301.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,Identifier,ContactDetail,UsageContext,CodeableConcept,Coding,BackboneElement,ElementDefinition
...
class StructureDefinitionMapping(BackboneElement):
    ...
    identity_ext: Optional[Extension] = Field(
...
class StructureDefinition(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='4.3.0', profile=['http://hl7.org/fhir/StructureDefinition/StructureDefinition']),
    )
    ...
    contextInvariant_ext: Optional[Extension] = Field(
    ...
    baseDefinition_ext: Optional[Extension] = Field(
    ...
    derivation_ext: Optional[Extension] = Field(
