# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:21:44.142437.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,Identifier,CodeableConcept,BackboneElement,Quantity,Reference,Duration,Range
...
class SpecimenDefinition(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='4.3.0', profile=['http://hl7.org/fhir/StructureDefinition/SpecimenDefinition']),
    )
