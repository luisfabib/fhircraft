# Code autogenerated by Fhircraft 0.2.0 on 2025-09-19 11:21:06.259399.
...
from fhircraft.fhir.resources.datatypes.R4B.complex_types import Extension,Meta,Narrative,Resource,Identifier,Reference,CodeableConcept,BackboneElement,CodeableReference,Ratio,RatioRange
...
class IngredientSubstanceStrengthReferenceStrength(BackboneElement):
    ...
    measurementPoint_ext: Optional[Extension] = Field(
...
class IngredientSubstanceStrength(BackboneElement):
    ...
    textPresentation_ext: Optional[Extension] = Field(
    ...
    textConcentration_ext: Optional[Extension] = Field(
    ...
    @field_validator(*('referenceStrength', 'country', 'measurementPoint', 'textConcentration', 'textPresentation', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
...
class Ingredient(FHIRBaseModel):
    ...
    meta: Optional[Meta] = Field(
        ...
        default_factory=lambda: Meta(versionId='4.3.0', profile=['http://hl7.org/fhir/StructureDefinition/Ingredient']),
    )
    ...
    @field_validator(*('substance', 'manufacturer', 'allergenicIndicator', 'function', 'role', 'for_', 'status', 'identifier', 'modifierExtension', 'extension', 'text', 'language', 'implicitRules', 'meta'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):    
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count()) or $this is Parameters",
