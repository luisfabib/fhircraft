...
class StructureMapInput(BackboneElement):
    name: Id = Field(
...
class StructureMapSource(BackboneElement):
    context: Id = Field(
...
class StructureMapTarget(BackboneElement):
    ...
    parameter: Optional[List[StructureMapParameter]] = Field(
...
class StructureMapDependent(BackboneElement):
    name: Id = Field(
    ...
    parameter: List[StructureMapParameter] = Field(
...
class StructureMapRule(BackboneElement):
    name: Optional[Id] = Field(
    ...
    source: List[StructureMapSource] = Field(
        description="Source inputs to the mapping",
    )
    target: Optional[List[StructureMapTarget]] = Field(
        description="Content to create because of this mapping rule",
        default=None,
    )
    dependent: Optional[List[StructureMapDependent]] = Field(
        description="Which other rules to apply in the context of this rule",
        default=None,
    )
    rule: Optional[List['StructureMapRule']] = Field(
    ...
    @field_validator(*('documentation', 'dependent', 'target', 'source', 'name', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension', 'modifierExtension', 'extension'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
...
class StructureMapGroup(BackboneElement):
    ...
    input: List[StructureMapInput] = Field(
...
class StructureMap(FHIRBaseModel):
    ...
    @field_validator(*('group', 'const', 'imports', 'structure', 'copyrightLabel', 'copyright', 'purpose', 'jurisdiction', 'useContext', 'description', 'contact', 'publisher', 'date', 'experimental', 'status', 'title', 'name', 'version', 'identifier', 'url', 'modifierExtension', 'extension', 'text', 'language', 'implicitRules', 'meta'), mode="after", check_fields=None)
    @classmethod
    def FHIR_ele_1_constraint_validator(cls, value):
        return fhir_validators.validate_element_constraint(cls, value, 
            expression="hasValue() or (children().count() > id.count())",
