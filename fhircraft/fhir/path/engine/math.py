...
class FHIRMathOperator(FHIRPath):
    ...
    def evaluate(
        ...
        left_collection = [
            self.convert_to_fhirpath_types(item) for item in left_collection
        ]
        ...
        right_collection = [
            self.convert_to_fhirpath_types(item) for item in right_collection
        ]
...
class Addition(FHIRMathOperator):
    ...
    def evaluate(
        ...
        if not isinstance(left, (int, float, str, Quantity)) or not isinstance(
            right, (int, float, str, Quantity)
        ):
            return []
        try:
            return left + right
...
class Subtraction(FHIRMathOperator):
    ...
    def evaluate(
        ...
        """
        left, right = super().evaluate(collection, *args, **kwargs)
        if not isinstance(left, (int, float, Quantity)) or not isinstance(
            right, (int, float, Quantity)
        ):
            return []
        try:
            return left - right
